...
if [ ! -r zulu15.28.51-ca-jre15.0.1-macosx_x64.zip ]; then
   echo zulu15.28.51-ca-jre15.0.1-macosx_x64.zip is missing, download from 'https://www.azul.com/downloads/zulu-community/?&version=java-11-lts&os=macos&os-details=macOS&architecture=x86-64-bit&package=jre'
   exit 1
fi
...
unzip -x ../../../zulu15.28.51-ca-jre15.0.1-macosx_x64.zip >/dev/null
mv zulu15.28.51-ca-jre15.0.1-macosx_x64 jre
cd - >/dev/null
