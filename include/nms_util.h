...
public:
   ...
   const T& operator[](ssize_t index) const { return buffer()[index]; }
#ifdef __64BIT__
   ...
   const T& operator[](uint32_t index) const { return buffer()[index]; }
#endif
...
public:
   ...
   json_t *toJson() const
   {
      ...
      for(int i = 0; i < size(); i++)
         json_array_append_new(a, json_integer(get(i)));
      return a;
   }
