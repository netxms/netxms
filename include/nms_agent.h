...
#define DCIDESC_PHYSICALDISK_SMARTATTR_RAW           _T("Raw value of SMART attribute {instance}")
#define DCIDESC_PHYSICALDISK_SMARTATTR_RAWSTRING     _T("Raw value (vendor-specific string) of SMART attribute {instance}")
#define DCIDESC_PHYSICALDISK_SMARTATTR_THRESHOLD     _T("Failure threshold of SMART attribute {instance}")
#define DCIDESC_PHYSICALDISK_SMARTATTR_WORST         _T("Worst recorded value of SMART attribute {instance}")
