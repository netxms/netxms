 ...
 */
#define CLIENT_PROTOCOL_VERSION_BASE      53    /* Base protocol version - must match for all clients */
...
#define CLIENT_PROTOCOL_VERSION_FULL      29    /* All functionality */
