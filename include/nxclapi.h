/* $Id: nxclapi.h,v 1.289 2008-03-06 22:55:53 victor Exp $ */
/* 
...
#define OBJ_UPDATE_NAME             ((QWORD)0x0000000001)
#define OBJ_UPDATE_AGENT_PORT       ((QWORD)0x0000000002)
#define OBJ_UPDATE_AGENT_AUTH       ((QWORD)0x0000000004)
#define OBJ_UPDATE_AGENT_SECRET     ((QWORD)0x0000000008)
#define OBJ_UPDATE_SNMP_VERSION     ((QWORD)0x0000000010)
#define OBJ_UPDATE_SNMP_COMMUNITY   ((QWORD)0x0000000020)
#define OBJ_UPDATE_ACL              ((QWORD)0x0000000040)
#define OBJ_UPDATE_IMAGE            ((QWORD)0x0000000080)
#define OBJ_UPDATE_SYNC_NETS        ((QWORD)0x0000000100)
#define OBJ_UPDATE_SERVICE_TYPE     ((QWORD)0x0000000200)
#define OBJ_UPDATE_IP_PROTO         ((QWORD)0x0000000400)
#define OBJ_UPDATE_IP_PORT          ((QWORD)0x0000000800)
#define OBJ_UPDATE_CHECK_REQUEST    ((QWORD)0x0000001000)
#define OBJ_UPDATE_CHECK_RESPONSE   ((QWORD)0x0000002000)
#define OBJ_UPDATE_POLLER_NODE      ((QWORD)0x0000004000)
#define OBJ_UPDATE_IP_ADDR          ((QWORD)0x0000008000)
#define OBJ_UPDATE_PEER_GATEWAY     ((QWORD)0x0000010000)
#define OBJ_UPDATE_NETWORK_LIST     ((QWORD)0x0000020000)
#define OBJ_UPDATE_STATUS_ALG       ((QWORD)0x0000040000)
#define OBJ_UPDATE_PROXY_NODE       ((QWORD)0x0000080000)
#define OBJ_UPDATE_NODE_FLAGS       ((QWORD)0x0000100000)
#define OBJ_UPDATE_ACT_EVENT        ((QWORD)0x0000200000)
#define OBJ_UPDATE_DEACT_EVENT      ((QWORD)0x0000400000)
#define OBJ_UPDATE_SOURCE_OBJECT    ((QWORD)0x0000800000)
#define OBJ_UPDATE_ACTIVE_STATUS    ((QWORD)0x0001000000)
#define OBJ_UPDATE_INACTIVE_STATUS  ((QWORD)0x0002000000)
#define OBJ_UPDATE_DCI_LIST         ((QWORD)0x0004000000)
#define OBJ_UPDATE_SCRIPT           ((QWORD)0x0008000000)
#define OBJ_UPDATE_CLUSTER_TYPE		((QWORD)0x0010000000)
#define OBJ_UPDATE_RESOURCES			((QWORD)0x0020000000)
#define OBJ_UPDATE_SNMP_PROXY			((QWORD)0x0040000000)
#define OBJ_UPDATE_REQUIRED_POLLS   ((QWORD)0x0080000000)
#define OBJ_UPDATE_TRUSTED_NODES    ((QWORD)0x0100000000)
