...
// unused: #define CMD_GET_OBJECT_COMMENTS           0x00B8
...
#define VID_SERVER_BUILD            ((UINT32)306)
#define VID_TRUSTED_OBJECTS         ((UINT32)307)
...
#define VID_LINK_WIDTH              ((UINT32)586)
#define VID_LINK_STYLE              ((UINT32)587)
...
#define VID_ZONE_PORT_COUNT         ((UINT32)607)
#define VID_HISTORICAL_DATA_TYPE    ((UINT32)608)
#define VID_JOB_CANCELLED           ((UINT32)609)
