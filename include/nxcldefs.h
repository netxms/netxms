...
#define RCC_SUBNET_OVERLAP                ((uint32_t)145)
#define RCC_NEED_2FA                      ((uint32_t)146)
#define RCC_FAILED_2FA_VALIDATION         ((uint32_t)147)
#define RCC_FAILED_2FA_PREPARATION        ((uint32_t)148)
#define RCC_NO_SUCH_2FA_METHOD            ((uint32_t)149)
#define RCC_NO_SUCH_2FA_DRIVER            ((uint32_t)150)
#define RCC_INVALID_2FA_BINDING_CONFIG    ((uint32_t)151)
#define RCC_NO_SUCH_2FA_BINDING           ((uint32_t)152)
...
#define SYSTEM_ACCESS_XMPP_COMMANDS           MASK_BIT64(26)
