...
#define SYSTEM_ACCESS_USERS_SCHEDULE      _ULL(0x040000000)
#define SYSTEM_ACCESS_ONE_USER_SCHEDULE   _ULL(0x080000000)
#define SYSTEM_ACCESS_ALL_SCHEDULE        _ULL(0x100000000)
#define SYSTEM_ACCESS_SCHEDULE_SCRIPT     _ULL(0x200000000)

#define SYSTEM_ACCESS_FULL                _ULL(0x2FFFFFFFF)
