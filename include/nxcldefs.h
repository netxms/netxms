...
//#define USER_MODIFY_XMPP_ID          0x00000800 reserved for future reuse
...
//#define TCF_INSTANCE_LABEL_COLUMN   ((uint16_t)0x0200) not used
...
#define CFG_IMPORT_REPLACE_AM_DEFINITIONS             0x0400
