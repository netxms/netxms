...
#define OBJECT_BUSINESSSERVICEPROTO  15
#define OBJECT_ASSET                 16
#define OBJECT_ASSETGROUP            17
#define OBJECT_ASSETROOT             18
 ...
 * Node flags
 */
#define NF_DISABLE_NETCONF             0x00002000
...
#define NX_NOTIFY_2FA_METHOD_CHANGED          56
#define NX_NOTIFY_BIZSVC_CHECK_MODIFIED       57
...
#define RCC_SUBNET_OVERLAP                ((uint32_t)146)
#define RCC_NEED_2FA                      ((uint32_t)147)
#define RCC_FAILED_2FA_VALIDATION         ((uint32_t)148)
#define RCC_FAILED_2FA_PREPARATION        ((uint32_t)149)
#define RCC_NO_SUCH_2FA_METHOD            ((uint32_t)150)
...
#define SYSTEM_ACCESS_MANAGE_USERS            MASK_BIT64(0)
#define SYSTEM_ACCESS_SERVER_CONFIG           MASK_BIT64(1)
#define SYSTEM_ACCESS_CONFIGURE_TRAPS         MASK_BIT64(2)
#define SYSTEM_ACCESS_MANAGE_SESSIONS         MASK_BIT64(3)
#define SYSTEM_ACCESS_VIEW_EVENT_DB           MASK_BIT64(4)
#define SYSTEM_ACCESS_EDIT_EVENT_DB           MASK_BIT64(5)
#define SYSTEM_ACCESS_EPP                     MASK_BIT64(6)
#define SYSTEM_ACCESS_MANAGE_ACTIONS          MASK_BIT64(7)
#define SYSTEM_ACCESS_DELETE_ALARMS           MASK_BIT64(8)
#define SYSTEM_ACCESS_MANAGE_PACKAGES         MASK_BIT64(9)
#define SYSTEM_ACCESS_VIEW_EVENT_LOG          MASK_BIT64(10)
#define SYSTEM_ACCESS_MANAGE_TOOLS            MASK_BIT64(11)
#define SYSTEM_ACCESS_MANAGE_SCRIPTS          MASK_BIT64(12)
#define SYSTEM_ACCESS_VIEW_TRAP_LOG           MASK_BIT64(13)
#define SYSTEM_ACCESS_VIEW_AUDIT_LOG          MASK_BIT64(14)
#define SYSTEM_ACCESS_MANAGE_AGENT_CFG        MASK_BIT64(15)
...
#define SYSTEM_ACCESS_USER_SCHEDULED_TASKS    MASK_BIT64(30)
#define SYSTEM_ACCESS_OWN_SCHEDULED_TASKS     MASK_BIT64(31)
#define SYSTEM_ACCESS_ALL_SCHEDULED_TASKS     MASK_BIT64(32)
#define SYSTEM_ACCESS_SCHEDULE_SCRIPT         MASK_BIT64(33)
#define SYSTEM_ACCESS_SCHEDULE_FILE_UPLOAD    MASK_BIT64(34)
#define SYSTEM_ACCESS_SCHEDULE_MAINTENANCE    MASK_BIT64(35)
#define SYSTEM_ACCESS_MANAGE_REPOSITORIES     MASK_BIT64(36)
#define SYSTEM_ACCESS_VIEW_REPOSITORIES       MASK_BIT64(37)
#define SYSTEM_ACCESS_VIEW_ALL_ALARMS         MASK_BIT64(38)
#define SYSTEM_ACCESS_EXTERNAL_INTEGRATION    MASK_BIT64(39)
#define SYSTEM_ACCESS_SETUP_TCP_PROXY         MASK_BIT64(40)
#define SYSTEM_ACCESS_IMPORT_CONFIGURATION    MASK_BIT64(41)
#define SYSTEM_ACCESS_UA_NOTIFICATIONS        MASK_BIT64(42)
#define SYSTEM_ACCESS_WEB_SERVICE_DEFINITIONS MASK_BIT64(43)
#define SYSTEM_ACCESS_OBJECT_CATEGORIES       MASK_BIT64(44)
#define SYSTEM_ACCESS_MANAGE_GEO_AREAS        MASK_BIT64(45)
...
#define SYSTEM_ACCESS_USE_AI_ASSISTANT        MASK_BIT64(53)
#define SYSTEM_ACCESS_MANAGE_AI_SKILLS       MASK_BIT64(54)
#define SYSTEM_ACCESS_VIEW_NOTIFICATION_LOG   MASK_BIT64(55)
#define SYSTEM_ACCESS_VIEW_ACTION_LOG         MASK_BIT64(56)
#define SYSTEM_ACCESS_SCAN_NETWORK            MASK_BIT64(57)
#define SYSTEM_ACCESS_MANAGE_AI_OPERATORS     MASK_BIT64(58)
#define SYSTEM_ACCESS_HTTP_REQUESTS           MASK_BIT64(59)

#define SYSTEM_ACCESS_FULL                    _ULL(0x0FFFFFFFFFFFFFFF)
 ...
 */
#define OBJECT_ACCESS_READ             _ULL(0x00000001)
#define OBJECT_ACCESS_MODIFY           _ULL(0x00000002)
#define OBJECT_ACCESS_CREATE           _ULL(0x00000004)
#define OBJECT_ACCESS_DELETE           _ULL(0x00000008)
#define OBJECT_ACCESS_READ_ALARMS      _ULL(0x00000010)
#define OBJECT_ACCESS_ACL              _ULL(0x00000020)
#define OBJECT_ACCESS_UPDATE_ALARMS    _ULL(0x00000040)
#define OBJECT_ACCESS_SEND_EVENTS      _ULL(0x00000080)
#define OBJECT_ACCESS_CONTROL          _ULL(0x00000100)
#define OBJECT_ACCESS_TERM_ALARMS      _ULL(0x00000200)
#define OBJECT_ACCESS_PUSH_DATA        _ULL(0x00000400)
#define OBJECT_ACCESS_CREATE_ISSUE     _ULL(0x00000800)
#define OBJECT_ACCESS_DOWNLOAD         _ULL(0x00001000)
#define OBJECT_ACCESS_UPLOAD           _ULL(0x00002000)
#define OBJECT_ACCESS_MANAGE_FILES     _ULL(0x00004000)
#define OBJECT_ACCESS_MAINTENANCE      _ULL(0x00008000)
#define OBJECT_ACCESS_READ_AGENT       _ULL(0x00010000)
#define OBJECT_ACCESS_READ_SNMP        _ULL(0x00020000)
#define OBJECT_ACCESS_SCREENSHOT       _ULL(0x00040000)
#define OBJECT_ACCESS_WRITE_MJOURNAL   _ULL(0x00080000)
#define OBJECT_ACCESS_CONFIGURE_AGENT  _ULL(0x00100000)
#define OBJECT_ACCESS_EDIT_COMMENTS    _ULL(0x00200000)
#define OBJECT_ACCESS_EDIT_RESP_USERS  _ULL(0x00400000)
#define OBJECT_ACCESS_DELEGATED_READ   _ULL(0x00800000)
#define OBJECT_ACCESS_MANAGE_POLICIES  _ULL(0x01000000)
#define OBJECT_ACCESS_MANAGE_INCIDENTS _ULL(0x02000000)
#define OBJECT_ACCESS_READ_CREDENTIALS _ULL(0x04000000)
#define OBJECT_ACCESS_QUERY_WEBSVC     _ULL(0x08000000)
#define OBJECT_ACCESS_UPLOAD_DEVICE_CONFIG _ULL(0x10000000)
...
#define USER_MODIFY_UI_ACCESS_RULES    0x00000800
 ...
 */
#define RF_STOP_PROCESSING       0x000001
#define RF_NEGATED_SOURCE        0x000002
#define RF_NEGATED_EVENTS        0x000004
#define RF_GENERATE_ALARM        0x000008
#define RF_DISABLED              0x000010
#define RF_TERMINATE_BY_REGEXP   0x000020
#define RF_SEVERITY_INFO         0x000100
#define RF_SEVERITY_WARNING      0x000200
#define RF_SEVERITY_MINOR        0x000400
#define RF_SEVERITY_MAJOR        0x000800
#define RF_SEVERITY_CRITICAL     0x001000
#define RF_CREATE_TICKET         0x002000
#define RF_ACCEPT_CORRELATED     0x004000
 ...
 */
#define CFG_IMPORT_REPLACE_EVENTS                     0x00000001
#define CFG_IMPORT_REPLACE_ACTIONS                    0x00000002
#define CFG_IMPORT_REPLACE_TEMPLATES                  0x00000004
#define CFG_IMPORT_REPLACE_TRAPS                      0x00000008
#define CFG_IMPORT_REPLACE_SCRIPTS                    0x00000010
#define CFG_IMPORT_REPLACE_SUMMARY_TABLES             0x00000020
#define CFG_IMPORT_REPLACE_OBJECT_TOOLS               0x00000040
#define CFG_IMPORT_REPLACE_EPP_RULES                  0x00000080
#define CFG_IMPORT_REPLACE_TEMPLATE_NAMES_LOCATIONS   0x00000100
#define CFG_IMPORT_DELETE_EMPTY_TEMPLATE_GROUPS       0x00000200
#define CFG_IMPORT_REPLACE_WEB_SVCERVICE_DEFINITIONS  0x00000400
#define CFG_IMPORT_REPLACE_AM_DEFINITIONS             0x00000800
#define CFG_IMPORT_REPLACE_LOGPARSER_MACROS           0x00001000
#define CFG_IMPORT_REPLACE_SYSLOG_PARSERS             0x00002000
#define CFG_IMPORT_REPLACE_WINDOWS_LOG_PARSERS        0x00004000
#define CFG_IMPORT_REPLACE_MAPPING_TABLES             0x00008000
#define CFG_IMPORT_REPLACE_OTEL_LOG_PARSERS           0x00010000
#define CFG_IMPORT_REPLACE_NETCONF_QUERIES            0x00020000
#define CFG_IMPORT_REPLACE_EVERYTHING                 0x0003FFFF
