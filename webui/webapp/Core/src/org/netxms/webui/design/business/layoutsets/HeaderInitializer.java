...
public class HeaderInitializer implements ILayoutSetInitializer
{
	...
	public void initializeLayoutSet(final LayoutSet layoutSet)
	{
		...
		layoutSet.addImagePath(ILayoutSetConstants.HEADER_WAVE, path + "header_wave.png"); //$NON-NLS-1$
		layoutSet.addImagePath(ILayoutSetConstants.HEADER_RIGHT_BG, path + "header_right_bg.png"); //$NON-NLS-1$
