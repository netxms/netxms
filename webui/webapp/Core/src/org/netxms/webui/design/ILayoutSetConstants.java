...
public interface ILayoutSetConstants
{
	 ...
	 * Image paths
	 */
	public static final String IMAGE_PATH_BUSINESS = "theme/business/"; //$NON-NLS-1$

	/*
	 * LayoutSet Ids
	 */
	public static final String SET_ID_CONFIG_DIALOG = "org.netxms.webui.design.layoutset.confdialog"; //$NON-NLS-1$
	public static final String SET_ID_COOLBAR = "org.netxms.webui.design.layoutset.coolbar"; //$NON-NLS-1$
	public static final String SET_ID_OVERFLOW = "org.netxms.webui.design.layoutset.coolbaroverflow"; //$NON-NLS-1$
	public static final String SET_ID_FOOTER = "org.netxms.webui.design.layoutset.footer"; //$NON-NLS-1$
	public static final String SET_ID_HEADER = "org.netxms.webui.design.layoutset.header"; //$NON-NLS-1$
	public static final String SET_ID_LOGO = "org.netxms.webui.design.layoutset.logo"; //$NON-NLS-1$
	public static final String SET_ID_MENUBAR = "org.netxms.webui.design.layoutset.menubar"; //$NON-NLS-1$
	public static final String SET_ID_PERSP = "org.netxms.webui.design.layoutset.perspective"; //$NON-NLS-1$
	public static final String SET_ID_STACKPRESENTATION = "org.netxms.webui.design.layoutset.stack"; //$NON-NLS-1$
