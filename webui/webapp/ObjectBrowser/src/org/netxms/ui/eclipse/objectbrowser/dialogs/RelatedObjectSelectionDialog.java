...
public class RelatedObjectSelectionDialog extends Dialog
{
    ...
    */
	...
	protected void configureShell(Shell newShell)
	{
      ...
      newShell.setText((relationType == RelationType.DIRECT_SUBORDINATES) ? Messages.get().ChildObjectListDialog_SelectSubordinate : "Select Parent Object");
		IDialogSettings settings = Activator.getDefault().getDialogSettings();
		try
		{
			newShell.setSize(settings.getInt("RelatedObjectSelectionDialog.cx"), settings.getInt("RelatedObjectSelectionDialog.cy")); //$NON-NLS-1$ //$NON-NLS-2$
		}
    ...
    */
	...
	protected Control createDialogArea(Composite parent)
	{
      ...
      AbstractObject object = ConsoleSharedData.getSession().findObjectById(seedObject);
    ...
    */
	...
	private void saveSettings()
	{
		...
		IDialogSettings settings = Activator.getDefault().getDialogSettings();
		settings.put("RelatedObjectSelectionDialog.cx", size.x); //$NON-NLS-1$
		settings.put("RelatedObjectSelectionDialog.cy", size.y); //$NON-NLS-1$
	}
