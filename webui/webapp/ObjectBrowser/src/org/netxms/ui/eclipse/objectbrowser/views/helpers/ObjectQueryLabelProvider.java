...
/**
 * Label provider for object query list
 */
public class ObjectQueryLabelProvider extends LabelProvider implements ITableLabelProvider
{
   /**
   ...
   public String getColumnText(Object element, int columnIndex)
   {
      switch(columnIndex)
      {
         case ObjectQueryManager.COL_DESCRIPTION:
            return ((ObjectQuery)element).getDescription();
         case ObjectQueryManager.COL_ID:
            return Integer.toString(((ObjectQuery)element).getId());
         case ObjectQueryManager.COL_IS_VALID:
            return ((ObjectQuery)element).isValid() ? "Yes" : "No";
