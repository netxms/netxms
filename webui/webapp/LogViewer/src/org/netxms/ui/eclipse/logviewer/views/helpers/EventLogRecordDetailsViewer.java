...
import org.netxms.ui.eclipse.logviewer.dialogs.EventLogRecordDetailsDialog;
...
public class EventLogRecordDetailsViewer implements LogRecordDetailsViewer
{
   ...
   {
      EventLogRecordDetailsDialog dlg = new EventLogRecordDetailsDialog(viewPart.getSite().getShell(), details);
      dlg.open();
   }
}
