...
{
	private final String[] OPERATIONS = { Messages.get().EventConditionEditor_Is, Messages.get().EventConditionEditor_IsNot };
	private final String EMPTY_SELECTION_TEXT = Messages.get().EventConditionEditor_None;
