...
public class SelectInternalParamDlg extends AbstractSelectParamDlg
{
	...
	protected void fillParameterList()
	{
		...
		{
         list.add(new AgentParameter("Server.AverageDataCollectorQueueSize", Messages.get().SelectInternalParamDlg_DCI_AvgDCQueue, DataCollectionItem.DT_FLOAT)); //$NON-NLS-1$
         ...
         list.add(new AgentParameter("Server.AverageEventWriterQueueSize", "Average event writer queue size for last minute", DataCollectionItem.DT_FLOAT)); //$NON-NLS-1$
         list.add(new AgentParameter("Server.AveragePollerQueueSize", "Average poller queue size for last minute", DataCollectionItem.DT_FLOAT)); //$NON-NLS-1$
         ...
         list.add(new AgentParameter("Server.Heap.Active", "Active server heap memory", DataCollectionItem.DT_UINT64)); //$NON-NLS-1$
         list.add(new AgentParameter("Server.Heap.Allocated", "Allocated server heap memory", DataCollectionItem.DT_UINT64)); //$NON-NLS-1$
         list.add(new AgentParameter("Server.Heap.Mapped", "Mapped server heap memory", DataCollectionItem.DT_UINT64)); //$NON-NLS-1$
