...
public class GeoAreaEditDialog extends Dialog
{
   ...
   protected void configureShell(Shell newShell)
   {
      ...
      newShell.setText((area != null) ? "Edit Geographical Area" : "Create Geographical Area");
   }
   ...
   protected void okPressed()
   {
      ...
      {
         MessageDialogHelper.openWarning(getShell(), "Warning", "Area name cannot be empty!");
         return;
      }
      ...
      for(String line : border.getText().split("\n"))
      {
         ...
         {
            Activator.log("Exception while parsing area border points", e);
            MessageDialogHelper.openWarning(getShell(), "Warning", String.format("Cannot parse area border point %s", line.trim()));
            return;
         }
      }
