...
/**
 * Show routing table for node
 */
public class ShowRoutingTable implements IObjectActionDelegate
{
	...
	public void run(IAction action)
	{
		try
		{
			window.getActivePage().showView(RoutingTableView.ID, Long.toString(objectId), IWorkbenchPage.VIEW_ACTIVATE);
		}
