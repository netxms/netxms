...
public class Messages extends NLS
{
   ...
   public String Authentication_LDAP;
   public String Authentication_Local;
   ...
   public String SystemRights_ManageImageLibrary;
   ...
   public String SystemRights_ManageAllScheduledTasks;
   ...
   public String SystemRights_ViewSyslog;
	public String SystemRights_ViewTrapLog;
	public String UserLabelProvider_Certificate;
   public String UserLabelProvider_CertificateOrPassword;
   public String UserLabelProvider_CertificateOrRADIUS;
   public String UserLabelProvider_Group;
   public String UserLabelProvider_LDAP;
   public String UserLabelProvider_Local;
   public String UserLabelProvider_Password;
   public String UserLabelProvider_RADIUS;
	public String UserLabelProvider_Unknown;
   public String UserLabelProvider_User;
	public String UserManagementView_7;
   public String UserManagementView_Authentication;
   ...
   public String UserManagementView_Source;
