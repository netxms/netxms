...
/**
 * Template graph properties property page
 */
public class TemplateGraph extends PropertyPage
{
   ...
   protected void applyChanges(final boolean isApply)
   {
      ...
      if (isApply)
      {
         ...
         new ConsoleJob("Update access control list for template graph", null, Activator.PLUGIN_ID, null) {
            @Override
            ...
            protected void jobFinalize()
            {
               runInUIThread(new Runnable() {
                  ...
                  public void run()
                  {
                     TemplateGraph.this.setValid(true);
                  }
               });
            }
