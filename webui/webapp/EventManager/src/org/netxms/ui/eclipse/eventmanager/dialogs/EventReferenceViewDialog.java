...
public class EventReferenceViewDialog extends Dialog
{
   ...
   protected void createButtonsForButtonBar(Composite parent)
   {
      ...
      if (showWarning)
      {
         if (multiChoice)
         {
            createButton(parent, IDialogConstants.YES_ID, IDialogConstants.get().YES_LABEL, true);
            createButton(parent, IDialogConstants.YES_TO_ALL_ID, IDialogConstants.get().YES_TO_ALL_LABEL, false);
            createButton(parent, IDialogConstants.NO_ID, IDialogConstants.get().NO_LABEL, false);
            createButton(parent, IDialogConstants.NO_TO_ALL_ID, IDialogConstants.get().NO_TO_ALL_LABEL, false);
         }
         else
         {
            createButton(parent, IDialogConstants.YES_ID, IDialogConstants.get().YES_LABEL, true);
