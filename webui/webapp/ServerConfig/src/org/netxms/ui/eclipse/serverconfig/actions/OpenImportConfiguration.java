...
import org.netxms.ui.eclipse.serverconfig.views.ImportConfiguration;
import org.netxms.ui.eclipse.tools.MessageDialogHelper;

/**
 * Open server configuration view
 */
public class OpenImportConfiguration implements IWorkbenchWindowActionDelegate
{
	...
	public void run(IAction action)
	{
		...
		{	
			try 
			{
				window.getActivePage().showView(ImportConfiguration.ID);
			} 
