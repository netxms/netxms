...
public class ScheduledTaskView extends ViewPart
{
   ...
   public static final int TIMER_KEY = 10;
   ...
   {      
      final int[] widths = { 50, 100, 200, 400, 150, 150, 100, 200, 250, 200, 100 };
      final String[] names = { "Id", "Schedule Type", "Object", "Parameters", "Execution time", "Last execution time", "Execution status", "Administrative status", "Owner", "Comments", "Timer key" };
