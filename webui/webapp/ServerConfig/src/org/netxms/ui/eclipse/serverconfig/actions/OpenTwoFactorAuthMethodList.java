...
/**
 * Open two-factor authentication method list
 */
public class OpenTwoFactorAuthMethodList implements IWorkbenchWindowActionDelegate
{
	...
	public void run(IAction action)
	{
      if (window != null)
		{	
			try 
			{
            window.getActivePage().showView(TwoFactorAuthenticationMethods.ID);
			} 
