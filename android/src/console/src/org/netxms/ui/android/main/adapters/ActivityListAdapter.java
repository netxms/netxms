...
{
	private static final int[] activityId = { HomeScreen.ACTIVITY_ALARMS, HomeScreen.ACTIVITY_DASHBOARDS, HomeScreen.ACTIVITY_NODES, HomeScreen.ACTIVITY_GRAPHS, HomeScreen.ACTIVITY_MACADDRESS  };
	private static final int[] imageId = { R.drawable.alarms, R.drawable.dashboard, R.drawable.nodes, R.drawable.graphs, R.drawable.macaddress };
