...
static void TestInetAddress()
{
   ...
   StartTest(_T("InetAddress - isReserved() - IPv4"));
   a = InetAddress::parse("0.1.2.3");
   AssertTrue(a.isReserved());
   a = InetAddress::parse("192.168.1.1");
   AssertFalse(a.isReserved());
   a = InetAddress::parse("100.64.0.1");
   AssertFalse(a.isReserved());
   EndTest();

   StartTest(_T("InetAddress - isReserved() - IPv6"));
   a = InetAddress::parse("::10.0.0.1");
   AssertTrue(a.isReserved());
   a = InetAddress::parse("::ffff:10.0.0.1");
   AssertTrue(a.isReserved());
   a = InetAddress::parse("64:ff9b::10.0.0.1");
   AssertTrue(a.isReserved());
   a = InetAddress::parse("64:ff9b:1:abcd::1");
   AssertTrue(a.isReserved());
   a = InetAddress::parse("64:ff9b:2::1");
   AssertFalse(a.isReserved());
   a = InetAddress::parse("100::1");
   AssertTrue(a.isReserved());
   a = InetAddress::parse("100:0:0:1::1");
   AssertFalse(a.isReserved());
   a = InetAddress::parse("2001:0:4136:e378:8000:63bf:3fff:fdd2");
   AssertTrue(a.isReserved());
   a = InetAddress::parse("2001:1::1");
   AssertFalse(a.isReserved());
   a = InetAddress::parse("2001:db8::1");
   AssertFalse(a.isReserved());
   a = InetAddress::parse("2002:c000:204::1");
   AssertTrue(a.isReserved());
   a = InetAddress::parse("2003::1");
   AssertFalse(a.isReserved());
   a = InetAddress::parse("5f00:0:1::e000");
   AssertTrue(a.isReserved());
   a = InetAddress::parse("5f01::1");
   AssertFalse(a.isReserved());
   a = InetAddress::parse("fd12:3456::1");
   AssertFalse(a.isReserved());
   a = InetAddress::parse("2a00:1450::1");
   AssertFalse(a.isReserved());
   EndTest();
...
static void TestIntegerArray()
{
   ...
   array->add(2);
   array->add(1);
   array->add(_ULL(4294967297));
   array->add(18);
   array->add(_ULL(4294967297));
   AssertEquals(array->size(), 6);
   AssertEquals(array->get(6), static_cast<uint64_t>(0));
   AssertEquals(array->get(4), static_cast<uint64_t>(18));
   AssertEquals(array->get(0), static_cast<uint64_t>(2));
   EndTest();
   ...
   AssertEquals(array->get(0), static_cast<uint64_t>(2));
   AssertEquals(array->get(1), static_cast<uint64_t>(1));
   AssertEquals(array->get(2), static_cast<uint64_t>(4294967297));
