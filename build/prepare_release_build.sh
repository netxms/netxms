...
### Configuration
POM_FILES="src/java-common/netxms-base/pom.xml src/client/java/netxms-client/pom.xml src/client/nxapisrv/java/pom.xml src/agent/subagents/bind9/pom.xml src/agent/subagents/java/java/pom.xml src/agent/subagents/jmx/pom.xml src/agent/subagents/ubntlw/pom.xml"
