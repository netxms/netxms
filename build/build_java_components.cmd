...
call mvn -f src/client/nxshell/java/pom.xml -Dmaven.test.skip=true -Plauncher package
call mvn -f src/server/nxreportd/java/pom.xml -Dmaven.test.skip=true -Plauncher package

SET POM_FILES=src/libnxjava/java/pom.xml;src/agent/subagents/java/java/pom.xml
for %%p in (%POM_FILES%) do call mvn -f %%p -Dmaven.test.skip=true install
...
for %%p in (%POM_FILES%) do call mvn -f %%p -Dmaven.test.skip=true package
