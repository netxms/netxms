...
#endif
TCHAR g_szListenAddress[MAX_PATH] = _T("0.0.0.0");
...
BOOL Initialize(void)
{
   ...
   // Open log file
   nxlog_open((g_dwFlags & AF_USE_SYSLOG) ? NXHTTPD_SYSLOG_NAME : g_szLogFile,
   ...
   if (!NXCInitialize())
   {
      nxlog_write(MSG_NXCL_INIT_FAILED, EVENTLOG_ERROR_TYPE, NULL);
		return FALSE;
   }
...
void Main(void)
{
   nxlog_write(MSG_NXHTTPD_STARTED, EVENTLOG_INFORMATION_TYPE, NULL);
