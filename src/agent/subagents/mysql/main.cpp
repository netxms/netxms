...
static NETXMS_SUBAGENT_PARAM s_parameters[] =
{
   ...
   { _T("MySQL.InnoDB.ReadCacheHitRate(*)"), H_GlobalParameter, _T("innodbReadCacheHitRate"), DCI_DT_FLOAT, _T("MySQL: InnoDB read cache hit rate") },
   ...
   { _T("MySQL.MyISAM.KeyCacheReadHitRate(*)"), H_GlobalParameter, _T("myISAMKeyCacheReadHitRate"), DCI_DT_UINT64, _T("MySQL: MyISAM key cache read hit rate") },
   ...
   { _T("MySQL.MyISAM.KeyCacheWriteHitRate(*)"), H_GlobalParameter, _T("myISAMKeyCacheWriteHitRate"), DCI_DT_UINT64, _T("MySQL: MyISAM key cache write hit rate") },
   ...
   { _T("MySQL.Threads.CacheHitRate(*)"), H_GlobalParameter, _T("threadCacheHitRate"), DCI_DT_FLOAT, _T("MySQL: thread cache hit rate") },
