...
static NETXMS_SUBAGENT_PARAM m_parameters[] =
{
   ...
   { _T("Process.PrivateMemoryUsage(*)"), H_ProcessInfo,     CAST_TO_POINTER(PROCINFO_PRIVATE_MEMPERC, const TCHAR *), DCI_DT_FLOAT, DCIDESC_PROCESS_PRIVATEMEMORYUSAGE },
   { _T("Process.PrivateRSS(*)"),         H_ProcessInfo,     CAST_TO_POINTER(PROCINFO_PRIVATE_RSS, const TCHAR *), DCI_DT_INT64, DCIDESC_PROCESS_PRIVATE_RSS },
