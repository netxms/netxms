...
static NETXMS_SUBAGENT_PARAM m_parameters[] =
{
   ...
   { _T("Asterisk.CurrentCalls(*)"), H_CurrentCalls, NULL, DCI_DT_UINT, _T("Asterisk: current calls") },
   { _T("Asterisk.Events.CallBarred"), H_GlobalEventCounters, _T("B"), DCI_DT_UINT64, _T("Asterisk: call barred events") },
   { _T("Asterisk.Events.CallBarred(*)"), H_GlobalEventCounters, _T("B"), DCI_DT_UINT64, _T("Asterisk: call barred events") },
   { _T("Asterisk.Events.CallRejected"), H_GlobalEventCounters, _T("R"), DCI_DT_UINT64, _T("Asterisk: call rejected events") },
   { _T("Asterisk.Events.CallRejected(*)"), H_GlobalEventCounters, _T("R"), DCI_DT_UINT64, _T("Asterisk: call rejected events") },
   { _T("Asterisk.Events.ChannelUnavailable"), H_GlobalEventCounters, _T("U"), DCI_DT_UINT64, _T("Asterisk: channel unavailable events") },
   { _T("Asterisk.Events.ChannelUnavailable(*)"), H_GlobalEventCounters, _T("U"), DCI_DT_UINT64, _T("Asterisk: channel unavailable events") },
   { _T("Asterisk.Events.Congestion"), H_GlobalEventCounters, _T("C"), DCI_DT_UINT64, _T("Asterisk: congestion events") },
   { _T("Asterisk.Events.Congestion(*)"), H_GlobalEventCounters, _T("C"), DCI_DT_UINT64, _T("Asterisk: congestion events") },
   { _T("Asterisk.Events.NoRoute"), H_GlobalEventCounters, _T("N"), DCI_DT_UINT64, _T("Asterisk: no route events") },
   { _T("Asterisk.Events.NoRoute(*)"), H_GlobalEventCounters, _T("N"), DCI_DT_UINT64, _T("Asterisk: no route events") },
   { _T("Asterisk.Events.SubscriberAbsent"), H_GlobalEventCounters, _T("A"), DCI_DT_UINT64, _T("Asterisk: subscriber absent events") },
   { _T("Asterisk.Events.SubscriberAbsent(*)"), H_GlobalEventCounters, _T("A"), DCI_DT_UINT64, _T("Asterisk: subscriber absent events") },
   { _T("Asterisk.Peer.Events.CallBarred(*)"), H_PeerEventCounters, _T("B"), DCI_DT_UINT64, _T("Asterisk: peer {instance} call barred events") },
   { _T("Asterisk.Peer.Events.CallRejected(*)"), H_PeerEventCounters, _T("R"), DCI_DT_UINT64, _T("Asterisk: peer {instance} call rejected events") },
   { _T("Asterisk.Peer.Events.ChannelUnavailable(*)"), H_PeerEventCounters, _T("U"), DCI_DT_UINT64, _T("Asterisk: peer {instance} channel unavailable events") },
   { _T("Asterisk.Peer.Events.Congestion(*)"), H_PeerEventCounters, _T("C"), DCI_DT_UINT64, _T("Asterisk: peer {instance} congestion events") },
   { _T("Asterisk.Peer.Events.NoRoute(*)"), H_PeerEventCounters, _T("N"), DCI_DT_UINT64, _T("Asterisk: peer {instance} no route events") },
   { _T("Asterisk.Peer.Events.SubscriberAbsent(*)"), H_PeerEventCounters, _T("A"), DCI_DT_UINT64, _T("Asterisk: peer {instance} subscriber absent events") },
   ...
   { _T("Asterisk.TaskProcessor.Processed(*)"), H_TaskProcessorDetails, _T("P"), DCI_DT_UINT64, _T("Asterisk: task processor {instance} processed tasks") },
