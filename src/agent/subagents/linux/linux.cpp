...
static NETXMS_SUBAGENT_TABLE m_tables[] =
{
   ...
   { _T("Net.WireguardInterfaces"), H_WgIfTable, nullptr, _T("INDEX"), DCTDESC_WIREGUARD_INTERFACES },
   { _T("Net.WireguardPeers"), H_WgPeersTable, nullptr, _T("INDEX"), DCTDESC_WIREGUARD_PEERS },
