...
static NETXMS_SUBAGENT_PARAM m_parameters[] =
{
   ...
   { _T("Process.PrivateMemoryUsage(*)"), H_ProcessDetails, CAST_TO_POINTER(PROCINFO_PRIVATE_MEMPERC, const TCHAR *), DCI_DT_FLOAT, DCIDESC_PROCESS_PRIVATEMEMORYUSAGE },
   { _T("Process.PrivateRSS(*)"), H_ProcessDetails, CAST_TO_POINTER(PROCINFO_PRIVATE_RSS, const TCHAR *), DCI_DT_INT64, DCIDESC_PROCESS_PRIVATE_RSS },
   ...
   { _T("System.CPU.Count"), H_CpuCount, (const TCHAR*)"/sys/devices/system/cpu/present", DCI_DT_UINT, DCIDESC_SYSTEM_CPU_COUNT },
   { _T("System.CPU.CountOnline"), H_CpuCount, (const TCHAR*)"/sys/devices/system/cpu/online", DCI_DT_UINT, DCIDESC_SYSTEM_CPU_COUNT_ONLINE },
   { _T("System.CPU.CountOffline"), H_CpuCount, (const TCHAR*)"/sys/devices/system/cpu/offline", DCI_DT_UINT, DCIDESC_SYSTEM_CPU_COUNT_OFFLINE },
...
static NETXMS_SUBAGENT_TABLE m_tables[] =
{
   ...
   { _T("Net.Wireguard.Interfaces"), H_WgIfTable, nullptr, _T("INDEX"), DCTDESC_WIREGUARD_INTERFACES },
   { _T("Net.Wireguard.Peers"), H_WgPeersTable, nullptr, _T("INDEX"), DCTDESC_WIREGUARD_PEERS },
