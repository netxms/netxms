...
static NETXMS_SUBAGENT_PARAM m_parameters[] =
{
   ...
   { _T("Net.Interface.PacketsOut64(*)"), H_NetIfInfoFromProc, (TCHAR *)IF_INFO_PACKETS_OUT_64, DCI_DT_UINT64, DCIDESC_NET_INTERFACE_PACKETSOUT },
	...
	{ _T("Process.CPUTime(*)"), H_ProcessDetails, CAST_TO_POINTER(PROCINFO_CPUTIME, const TCHAR *), DCI_DT_UINT64, DCIDESC_PROCESS_CPUTIME },
	{ _T("Process.Handles(*)"), H_ProcessDetails, CAST_TO_POINTER(PROCINFO_HANDLES, const TCHAR *), DCI_DT_UINT, DCIDESC_PROCESS_HANDLES },
	{ _T("Process.KernelTime(*)"), H_ProcessDetails, CAST_TO_POINTER(PROCINFO_KTIME, const TCHAR *), DCI_DT_UINT64, DCIDESC_PROCESS_KERNELTIME },
	{ _T("Process.PageFaults(*)"), H_ProcessDetails, CAST_TO_POINTER(PROCINFO_PAGEFAULTS, const TCHAR *), DCI_DT_UINT64, DCIDESC_PROCESS_PAGEFAULTS },
	{ _T("Process.Threads(*)"), H_ProcessDetails, CAST_TO_POINTER(PROCINFO_THREADS, const TCHAR *), DCI_DT_UINT, DCIDESC_PROCESS_THREADS },
	{ _T("Process.UserTime(*)"), H_ProcessDetails, CAST_TO_POINTER(PROCINFO_UTIME, const TCHAR *), DCI_DT_UINT64, DCIDESC_PROCESS_USERTIME },
