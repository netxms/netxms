...
static NETXMS_SUBAGENT_PARAM m_parameters[] =
{
   ...
   { "System.CPU.PhysicalAverage", H_CpuUsage, MAKE_CPU_USAGE_PARAM(INTERVAL_1MIN, CPU_PA_OVERAL), DCI_DT_FLOAT,
         "Average Physical CPU utilization for last minute" },
   { "System.CPU.PhysicalAverage5", H_CpuUsage, MAKE_CPU_USAGE_PARAM(INTERVAL_5MIN, CPU_PA_OVERAL), DCI_DT_FLOAT,
         "Average Physical CPU utilization for last 5 minutes" },
   { "System.CPU.PhysicalAverage15", H_CpuUsage, MAKE_CPU_USAGE_PARAM(INTERVAL_15MIN, CPU_PA_OVERAL), DCI_DT_FLOAT,
