...
bool SMSCreatePDUString(const char* phoneNumber, const char* message, char* pduBuffer)
{
	...
	nxlog_debug_tag(DEBUG_TAG, 7, _T("SMSCreatePDUString: Formatted phone before: %hs,%d"), phoneNumberFormatted, phoneLength);
	...
	nxlog_debug_tag(DEBUG_TAG, 7, _T("SMSCreatePDUString: Formatted phone: %hs"), phoneNumberFormatted);
	SMSPack7BitChars(message, payload, &payloadSize, bufferSize);
	nxlog_debug_tag(DEBUG_TAG, 7, _T("SMSCreatePDUString: Got payload size: %d"), payloadSize);
