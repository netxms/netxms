...
#else
#define VALID_OPTIONS   "c:CdD:fFg:G:hkKM:p:P:r:u:vW:X:Z:z:"
#endif
...
uuid g_agentId;
#ifdef _WIN32
UINT32 g_dwFlags = AF_ENABLE_ACTIONS | AF_ENABLE_AUTOLOAD | AF_WRITE_FULL_DUMP | AF_ENABLE_PUSH_CONNECTOR | AF_ENABLE_CONTROL_CONNECTOR;
#else
UINT32 g_dwFlags = AF_ENABLE_ACTIONS | AF_ENABLE_AUTOLOAD | AF_ENABLE_PUSH_CONNECTOR;
#endif
...
BOOL Initialize()
{
   ...
   InitSubAgentAPI(WriteSubAgentMsg, SendTrap, SendTrap, EnumerateSessions, FindServerSessionByServerId,
      SendFileToServer, PushData, GetLocalDatabaseHandle, g_szDataDirectory);
