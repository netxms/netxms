...
static NETXMS_SUBAGENT_PARAM s_standardParams[] =
{
   ...
   { _T("PhysicalDisk.SmartAttrRaw(*)"), H_PhysicalDiskInfo, _T("R"), DCI_DT_UINT64, DCIDESC_PHYSICALDISK_SMARTATTR_RAW },
   { _T("PhysicalDisk.SmartAttrRawString(*)"), H_PhysicalDiskInfo, _T("B"), DCI_DT_STRING, DCIDESC_PHYSICALDISK_SMARTATTR_RAWSTRING },
   { _T("PhysicalDisk.SmartAttrThreshold(*)"), H_PhysicalDiskInfo, _T("H"), DCI_DT_UINT, DCIDESC_PHYSICALDISK_SMARTATTR_THRESHOLD },
   { _T("PhysicalDisk.SmartAttrWorst(*)"), H_PhysicalDiskInfo, _T("W"), DCI_DT_UINT, DCIDESC_PHYSICALDISK_SMARTATTR_WORST },
