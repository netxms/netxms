...
Source: "..\..\..\out\x64\Release\bin\entsoe.nsm"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
...
Source: "..\..\..\out\x64\Release\bin\openmeteo.nsm"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
...
Source: "..\..\..\out\x64\Release\bin\prometheus.nsm"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
...
Source: "..\..\install\files\windows\x64\libc++.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libunwind.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libwinpthread-1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libjq-1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libonig-5.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libcurl.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libexpat-1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libnxmodbus-5.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libpcre-1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libpcre16-0.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libmicrohttpd-12.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libprotobuf.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libsnappy.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
...
Source: "..\..\install\files\windows\x64\zlib1.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\capi.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
Source: "..\..\install\files\windows\x64\libcrypto-3-x64.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
...
Source: "..\..\install\files\windows\x64\libssl-3-x64.dll"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
