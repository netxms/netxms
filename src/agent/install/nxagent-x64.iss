...
Source: "..\..\..\x64\release\entsoe.nsm"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
...
Source: "..\..\..\x64\release\openmeteo.nsm"; DestDir: "{app}\bin"; Flags: ignoreversion signonce
