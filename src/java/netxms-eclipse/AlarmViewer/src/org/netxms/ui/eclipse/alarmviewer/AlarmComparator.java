	...
	public int compare(Viewer viewer, Object e1, Object e2)
	{
		...
		switch((Integer)sortColumn.getData("ID"))
		{
			...
			case AlarmList.COLUMN_SOURCE:
				NXCObject obj1 = NXMCSharedData.getInstance().getSession().findObjectById(((Alarm)e1).getSourceObjectId());
				NXCObject obj2 = NXMCSharedData.getInstance().getSession().findObjectById(((Alarm)e2).getSourceObjectId());
