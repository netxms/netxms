...
public class CreateNodeLink implements IObjectActionDelegate
{
	...
	public void run(IAction action)
	{
		...
		new ConsoleJob(Messages.get().CreateNodeLink_JobTitle, part, Activator.PLUGIN_ID, null) {
			@Override
			protected void runInternal(IProgressMonitor monitor) throws Exception
			{
				NXCObjectCreationData cd = new NXCObjectCreationData(AbstractObject.OBJECT_NODELINK, dlg.getName(), parentId);
			...
			{
				return String.format(Messages.get().CreateNodeLink_JobError, dlg.getName());
			}
		}.start();
	}
