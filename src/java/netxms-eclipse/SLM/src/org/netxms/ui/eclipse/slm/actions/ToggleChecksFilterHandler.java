 ...
 */
public class ToggleChecksFilterHandler extends AbstractHandler implements IElementUpdater
{
   /**
    ...
    */
	...
	public Object execute(ExecutionEvent event) throws ExecutionException
	{
		...
		if (object instanceof IEvaluationContext)
		{
         ...
         if ((tab != null) && (tab instanceof BusinessServiceChecks))
			{
            ...
            ((BusinessServiceChecks)tab).enableFilter(isChecked);
