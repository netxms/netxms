...
public class CreateTemplateGroup implements IObjectActionDelegate
{
	...
	{
		final CreateObjectDialog dlg = new CreateObjectDialog(window.getShell(), "Template Group");
		if (dlg.open() != Window.OK)
			return;
		
		new ConsoleJob("Create template group", part, Activator.PLUGIN_ID, null) {
			@Override
			...
			{
				return "Cannot create template group object \"" + dlg.getObjectName() + "\"";
			}
		}.start();
	}
