...
/**
 * Create network map group object
 *
 */
public class CreateMapGroup implements IObjectActionDelegate
{
	...
	public void run(IAction action)
	{
		...
		new ConsoleJob(Messages.get().CreateMapGroup_JobName, part, Activator.PLUGIN_ID, null) {
			...
			{
				NXCObjectCreationData cd = new NXCObjectCreationData(AbstractObject.OBJECT_NETWORKMAPGROUP, dlg.getObjectName(), parentId);
