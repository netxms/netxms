...
import org.netxms.ui.eclipse.nxsl.views.ScriptExecuter;
 ...
 *
 */
public class OpenAgentScriptExecuter implements IObjectActionDelegate
{
	...
	{	
	   if(window != null)
      {
   	   try
         {
            window.getActivePage().showView(ScriptExecuter.ID, Long.toString(node.getObjectId()), IWorkbenchPage.VIEW_ACTIVATE);
         }
