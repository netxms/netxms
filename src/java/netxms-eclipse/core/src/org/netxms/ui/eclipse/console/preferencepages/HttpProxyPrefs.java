...
public class HttpProxyPrefs extends PreferencePage implements IWorkbenchPreferencePage
{
	...
	protected Control createContents(Composite parent)
	{
		...
		checkUseProxy.setText(Messages.get().HttpProxyPrefs_UserProxyMessage); //$NON-NLS-1$
		...
		editProxyServer.setLabel(Messages.get().HttpProxyPrefs_ProxyServer); //$NON-NLS-1$
		...
		editProxyPort.setLabel(Messages.get().HttpProxyPrefs_Port); //$NON-NLS-1$
		...
		editExclusions.setLabel(Messages.get().HttpProxyPrefs_ExcludedAddresses); //$NON-NLS-1$
		...
		checkRequireAuth.setText(Messages.get().HttpProxyPrefs_ProxyRequireAuth); //$NON-NLS-1$
		...
		editLogin.setLabel(Messages.get().HttpProxyPrefs_Login); //$NON-NLS-1$
		...
		editPassword.setLabel(Messages.get().HttpProxyPrefs_Password); //$NON-NLS-1$
