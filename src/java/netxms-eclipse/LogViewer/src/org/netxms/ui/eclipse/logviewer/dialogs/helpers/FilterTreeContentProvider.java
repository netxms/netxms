...
public class FilterTreeContentProvider implements ITreeContentProvider
{
	...
	{
		return ((FilterTreeElement)parentElement).getChilds();
	}
	...
	{
		return ((FilterTreeElement)element).getParent();
	}
	...
	{
		return ((FilterTreeElement)element).hasChilds();
	}
	...
	{
		return ((List<FilterTreeElement>)inputElement).toArray();
	}
