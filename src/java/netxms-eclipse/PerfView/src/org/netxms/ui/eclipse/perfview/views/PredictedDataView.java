 ...
 */
public class PredictedDataView extends ViewPart
{
	public static final String ID = "org.netxms.ui.eclipse.perfview.views.PredictedDataView"; //$NON-NLS-1$
   ...
   public static final int COLUMN_DATA = 1;
	...
	private Date timeTo = new Date((new Date()).getTime() + 1000L*60L*60L); //one hour
	...
	private void refreshData()
	{
		...
		new ConsoleJob(Messages.get().HistoricalDataView_RefreshJobName, this, Activator.PLUGIN_ID, null) {
			...
			{
			   final DciData data = session.getPredictedData(nodeId, dciId, timeFrom, timeTo);
