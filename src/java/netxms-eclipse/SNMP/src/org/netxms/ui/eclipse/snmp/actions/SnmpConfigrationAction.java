 ...
 *
 */
public class SnmpConfigrationAction implements IWorkbenchWindowActionDelegate
{
	...
	public void run(IAction action)
	{
		...
		{	
			...
			{
				MessageDialogHelper.openError(window.getShell(), "Error opening view", "Error: " + e.getMessage());
			}
		}
	}
