 ...
 */
public class ZoneSSHCredentials extends PropertyPage
{
   private Zone zone;
    ...
    */
	private void loadConfig()
	{
      ...
      ConsoleJob job = new ConsoleJob(Messages.get().NetworkCredentials_LoadingConfig, null, Activator.PLUGIN_ID) {
         @Override
   ...
   {
      InputDialog dlg = new InputDialog(getShell(), "Add SSH Port", "Please enter SSH port", "", null); //$NON-NLS-3$
      if (dlg.open() == Window.OK)
      {
