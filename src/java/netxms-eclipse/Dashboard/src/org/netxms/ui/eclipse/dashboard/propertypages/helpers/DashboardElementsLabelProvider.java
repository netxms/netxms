...
{
	private static final String[] ELEMENT_TYPES = { "Label", "Line Chart", "Bar Chart", "Pie Chart", "Tube Chart", "Status Chart", "Status Indicator", "Dashboard", "Network Map", "Custom Widget" };
