...
public class EditCertificateDialog extends Dialog
{
    ...
    */
   public EditCertificateDialog(Shell parentShell, Certificate cert)
   {
      super(parentShell);
      this.cert = cert;
   }
