...
public class RackPassiveElementLabelProvider extends LabelProvider implements ITableLabelProvider
{
   ...
   public String getColumnText(Object element, int columnIndex)
   {
      ...
      switch(columnIndex)
      {
         case PatchPanelSelectonDialog.COLUMN_NAME:
            return entry.getName();
         case PatchPanelSelectonDialog.COLUMN_POSITION:
            return Integer.toString(entry.getPosition());
         case PatchPanelSelectonDialog.COLUMN_TYPE:
            return TYPE[entry.getType().getValue()];
         case PatchPanelSelectonDialog.COLUMN_ORIENTATION:
