 ...
 * 
 */
public class SavePolicyOnCloseDialog extends Dialog
{
    ...
    * @param parentShell
    */
   public SavePolicyOnCloseDialog(Shell parentShell)
   {
      super(parentShell);
   }
   ...
   protected Control createDialogArea(Composite parent)
   {
      ...
      image.setImage(Activator.getImageDescriptor("icons/unsaved_policy.png").createImage()); //$NON-NLS-1$
