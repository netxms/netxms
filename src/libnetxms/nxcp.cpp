...
TCHAR LIBNETXMS_EXPORTABLE *NXCPMessageCodeName(uint16_t code, TCHAR *buffer)
{
   static const TCHAR *messageNames[] =
   {
      ...
      _T("CMD_RETIRED_0x01DC"),
      _T("CMD_RETIRED_0x01DD"),
      ...
      _T("CMD_TRAP_ACK"),
      _T("CMD_GET_AI_OPERATORS"),
      _T("CMD_MODIFY_AI_OPERATOR"),
      _T("CMD_DELETE_AI_OPERATOR"),
      ...
      _T("CMD_NETCONF_EXECUTE"),
      _T("CMD_NETCONF_QUERY"),
      ...
      _T("CMD_GET_AI_OPERATOR_CHECKS"),
      _T("CMD_MODIFY_AI_OPERATOR_CHECK"),
      _T("CMD_DELETE_AI_OPERATOR_CHECK"),
      _T("CMD_GET_AI_OPERATOR_INSTR_HISTORY")
   };
   ...
   if ((code >= CMD_LOGIN) && (code <= CMD_GET_AI_OPERATOR_INSTR_HISTORY))
   {
