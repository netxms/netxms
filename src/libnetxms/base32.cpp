...
{
  static const char b32str[33] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
...
static bool base32_decode_ctx(struct base32_decode_context *ctx, const char *in, size_t inlen, char *out, size_t *outlen)
{
...
/* Allocate an output buffer in *OUT, and decode the base32 encoded
   ...
   *OUT and *OUTLEN parameters to differentiate between successful
   ...
   undefined. */
static bool base32_decode_alloc_ctx(struct base32_decode_context *ctx, const char *in, size_t inlen, char **out, size_t *outlen)
{
...
{
   return base32_decode_ctx(NULL, in, inlen, out, outlen);
}

bool LIBNETXMS_EXPORTABLE base32_decode_alloc(const char *in, size_t inlen, char **out, size_t *outlen)
{
   return base32_decode_alloc_ctx(NULL, in, inlen, out, outlen);
}
