 ...
 */
InterfaceList *DellOS10Driver::getInterfaces(DeviceContext *context, NObject *node, DriverData *driverData, bool useIfXTable)
{
 ...
 */
bool DellOS10Driver::getRunningConfig(DeviceContext *ctx, ByteStream *output)
{
 ...
 */
bool DellOS10Driver::getStartupConfig(DeviceContext *ctx, ByteStream *output)
{
   SSHInteractiveChannel *ssh = ctx->getInteractiveSSH();
   if (ssh == nullptr)
      return false;
