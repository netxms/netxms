 ...
 */
bool DellFTOSDriver::getHardwareInformation(DeviceContext *context, NObject *node, DriverData *driverData, DeviceHardwareInfo *hwInfo)
{
 ...
 */
InterfaceList *DellFTOSDriver::getInterfaces(DeviceContext *context, NObject *node, DriverData *driverData, bool useIfXTable)
{
 ...
 */
bool DellFTOSDriver::getRunningConfig(DeviceContext *ctx, ByteStream *output)
{
 ...
 */
bool DellFTOSDriver::getStartupConfig(DeviceContext *ctx, ByteStream *output)
{
   SSHInteractiveChannel *ssh = ctx->getInteractiveSSH();
   if (ssh == nullptr)
      return false;
