 ...
 * @param oid Device OID
 */
bool HPSwitchDriver::isDeviceSupported(DeviceContext *context, const SNMP_ObjectId& oid)
{
	return true;
}
 ...
 * @param node Node
 */
InterfaceList *HPSwitchDriver::getInterfaces(DeviceContext *context, NObject *node, DriverData *driverData, bool useIfXTable)
{
