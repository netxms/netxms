...
** Driver for Cisco 4400 and Cisco Aironet (former Airespace) wireless switches
...
#ifndef _airespace_h_
#define _airespace_h_
 ...
 * Driver's class
 */
class AirespaceDriver : public NetworkDeviceDriver
{
public:
