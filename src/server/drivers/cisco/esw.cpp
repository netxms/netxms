 ...
 * @param oid Device OID
 */
bool CiscoEswDriver::isDeviceSupported(DeviceContext *context, const SNMP_ObjectId& oid)
{
	return true;
}
 ...
 */
bool CiscoEswDriver::getHardwareInformation(DeviceContext *context, NObject *node, DriverData *driverData, DeviceHardwareInfo *hwInfo)
{
 ...
 */
InterfaceList *CiscoEswDriver::getInterfaces(DeviceContext *context, NObject *node, DriverData *driverData, bool useIfXTable)
{
