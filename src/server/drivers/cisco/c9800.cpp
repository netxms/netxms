 ...
 */
bool CiscoC9800Driver::getVirtualizationType(DeviceContext *context, NObject *node, DriverData *driverData, VirtualizationType *vtype)
{
   TCHAR sysDescr[1024];
   if (!ReadSysDescr(context->getSNMPTransport(), sysDescr, sizeof(sysDescr)))
      return false;
 ...
 */
int CiscoC9800Driver::getClusterMode(DeviceContext *context, NObject *node, DriverData *driverData)
{
 ...
 * @param driverData optional pointer to user data
 */
bool CiscoC9800Driver::isWirelessController(DeviceContext *context, NObject *node, DriverData *driverData)
{
   return true;
}
 ...
 * @param driverData optional pointer to user data
 */
ObjectArray<AccessPointInfo> *CiscoC9800Driver::getAccessPoints(DeviceContext *context, NObject *node, DriverData *driverData)
{
 ...
 */
AccessPointState CiscoC9800Driver::getAccessPointState(DeviceContext *context, NObject *node, DriverData *driverData,
 ...
 * @param driverData optional pointer to user data
 */
ObjectArray<WirelessStationInfo> *CiscoC9800Driver::getWirelessStations(DeviceContext *context, NObject *node, DriverData *driverData)
{
   SNMP_Transport *snmp = context->getSNMPTransport();
