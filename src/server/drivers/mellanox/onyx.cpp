 ...
 * @param oid Device OID
 */
bool MellanoxOnyxDriver::isDeviceSupported(DeviceContext *context, const SNMP_ObjectId& oid)
{
   return true;
}
 ...
 */
void MellanoxOnyxDriver::getModuleLayout(DeviceContext *context, NObject *node, DriverData *driverData, int module, NDD_MODULE_LAYOUT *layout)
{
 ...
 */
InterfaceList *MellanoxOnyxDriver::getInterfaces(DeviceContext *context, NObject *node, DriverData *driverData, bool useIfXTable)
{
