 ...
 * Global variables
 */
LIBNXSRV_EXPORTABLE_VAR(VolatileCounter64 g_flags) = AF_USE_SYSLOG | AF_CATCH_EXCEPTIONS | AF_WRITE_FULL_DUMP | AF_CACHE_DB_ON_STARTUP | AF_ENABLE_LOCAL_ADMIN_INTERFACE;
