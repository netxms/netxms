 ...
 */
static std::string CallGlobalAIAssistantFunction(const char *name, json_t *arguments, uint32_t userId)
{
 ...
 */
static void FillAIAssistantFunctionListMessage(NXCPMessage *msg)
{
