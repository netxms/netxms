 ...
 */
DCObject::DCObject(json_t *json, const shared_ptr<DataCollectionOwner>& owner, bool nxslV5) : m_owner(owner), m_mutex(MutexType::RECURSIVE), m_accessList(0, 16)
{
   m_id = CreateUniqueId(IDG_ITEM);
   ...
   {
      setTransformationScript(NXSLConvertToV5(json_object_get_string(json, "transformation", _T(""))));
   }
   ...
   {
      setInstanceFilter(NXSLConvertToV5(json_object_get_string(json, "instanceFilter", _T(""))));
   }
 ...
 */
void DCObject::updateFromImport(json_t *json, bool nxslV5)
{
   lock();
   ...
   {
      setTransformationScript(NXSLConvertToV5(transformation));
   }
   ...
   {
      setInstanceFilter(NXSLConvertToV5(instanceFilter));
   }
