...
#define AF_RECORD_EVENT_PROCESSING_METADATA    _LL(0x0000200000000000)
...
#define AF_SYNC_NODE_NAMES_WITH_SNMP_SYSNAME   _LL(0x0400000000000000)
#define AF_ENABLE_LOCAL_ADMIN_INTERFACE        _LL(0x0800000000000000)
