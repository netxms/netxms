...
typedef struct
{
   ...
   char *(*pfProcessRequestToAiAssistant)(const char *userPrompt, NetObj *context, GenericClientSession *session);
   uint32_t (*pfClearAiAssistantChat)(GenericClientSession *session);
