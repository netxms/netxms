...
typedef struct
{
   ...
   void (*pfOnResponsibleUserListChange)(NetObj *object, const StructArray<ResponsibleUser> *oldList, const StructArray<ResponsibleUser> *newList, GenericClientSession *session);
