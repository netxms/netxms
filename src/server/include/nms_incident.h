...
private:
   ...
   void postStateChangeEvent(int oldState, int newState, uint32_t userId);

public:
   Incident();
   Incident(uint32_t id, uint32_t sourceObjectId, const TCHAR *title, const TCHAR *description,
