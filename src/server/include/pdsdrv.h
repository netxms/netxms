...
public:
   ...
   virtual bool saveDCItemValue(DCItem *dcObject, int64_t timestamp, const wchar_t *value);
   virtual bool saveDCTableValue(DCTable *dcObject, int64_t timestamp, Table *value);
