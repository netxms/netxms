...
void NXCORE_EXPORTABLE SendNotification(const TCHAR *name, TCHAR *recipient, const TCHAR *subject, const TCHAR *message, uint32_t eventCode, uint64_t eventId, const uuid& ruleId, const TCHAR *ruleDescription = nullptr, bool isMarkdown = false, const GeoLocation& location = GeoLocation());
void NXCORE_EXPORTABLE SendNotification(const TCHAR *name, TCHAR *recipient, const TCHAR *subject, const TCHAR *message, const Event *event, const shared_ptr<NetObj>& sourceObject, const uuid& ruleId, const TCHAR *ruleDescription = nullptr, bool isMarkdown = false, const GeoLocation& location = GeoLocation());
...
uint32_t ExecuteTableTool(uint32_t toolId, const shared_ptr<Node>& node, uint32_t requestId, ClientSession *session,
      const StringMap *inputFields = nullptr, const StringList *maskedFields = nullptr);
...
uint32_t NXCORE_EXPORTABLE ExecuteTableToolToJSON(uint32_t toolId, const shared_ptr<Node>& node, json_t **result,
      const StringMap *inputFields = nullptr, const StringList *maskedFields = nullptr, const wchar_t *userName = nullptr);
...
extern uint32_t g_agentConnectionTimeout;
extern uint32_t g_agentConnectionRetries;
