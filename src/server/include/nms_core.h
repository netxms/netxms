...
template class NXCORE_EXPORTABLE ObjectMemoryPool<std::shared_ptr<AgentFileTransfer>>;
template class NXCORE_EXPORTABLE SharedPointerIndex<AgentFileTransfer>;
template class NXCORE_EXPORTABLE ObjectMemoryPool<std::shared_ptr<ProcessExecutor>>;
