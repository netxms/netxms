   ...
   static TCHAR m_szBatch[] =
      ...
      "INSERT INTO events (event_id,name,severity,flags,message,description) VALUES "
	      "(506, 'SNMP_EGP_NEIGHBOR_LOSS',	1, 1,	'EGP neighbor loss',"
		   ...
		   "Parameters:#0D#0A   1) SNMP trap OID')\n"
      "INSERT INTO snmp_trap_cfg (trap_id,snmp_oid,event_id,sequence,description) "
         "VALUES (1,'.1.3.6.1.6.3.1.1.5.1',501,1,'Generic coldStart trap')\n"
      "INSERT INTO snmp_trap_cfg (trap_id,snmp_oid,event_id,sequence,description) "
         "VALUES (2,'.1.3.6.1.6.3.1.1.5.2',502,2,'Generic warmStart trap')\n"
      "INSERT INTO snmp_trap_cfg (trap_id,snmp_oid,event_id,sequence,description) "
         "VALUES (3,'.1.3.6.1.6.3.1.1.5.3',503,3,'Generic linkDown trap')\n"
      "INSERT INTO snmp_trap_cfg (trap_id,snmp_oid,event_id,sequence,description) "
         "VALUES (4,'.1.3.6.1.6.3.1.1.5.4',504,4,'Generic linkUp trap')\n"
      "INSERT INTO snmp_trap_cfg (trap_id,snmp_oid,event_id,sequence,description) "
         "VALUES (5,'.1.3.6.1.6.3.1.1.5.5',505,5,'Generic authenticationFailure trap')\n"
      "INSERT INTO snmp_trap_cfg (trap_id,snmp_oid,event_id,sequence,description) "
         "VALUES (6,'.1.3.6.1.6.3.1.1.5.6',506,6,'Generic egpNeighborLoss trap')\n"
