...
WithAssignment:
	T_IDENTIFIER '='
{
	pScript->addInstruction(new NXSL_Instruction(pLexer->getCurrLine(), OPCODE_CBLOCK, INVALID_ADDRESS));
} 
...
|	T_RETURN
{
   ...
   {
	   pScript->addInstruction(new NXSL_Instruction(pLexer->getCurrLine(), OPCODE_POP, (short)pCompiler->getForEachLevel()));
   }
