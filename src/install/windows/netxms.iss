...
#include "setup.iss"
OutputBaseFilename=netxms-2.1.1
...
Source: "..\..\..\Release\libnxjava.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: base
Source: "..\..\..\Release\libnxjava.pdb"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: base and pdb
Source: "..\..\..\Release\libnxmb.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: base
...
Source: "..\..\..\Release\jansson.dll"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: base
...
Source: "..\..\..\Release\smseagle.sms"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: server
...
Source: "..\..\..\Release\nxminfo.exe"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: server
...
Source: "..\..\..\Release\nxshell.exe"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: tools
