...
OutputBaseFilename=netxms-webui-1.2.5-x64
ArchitecturesInstallIn64BitMode=x64
ArchitecturesAllowed=x64

[Files]
Source: files-x64\jre\*; DestDir: "{app}\bin\jre"; BeforeInstall: StopAllServices; Flags: ignoreversion recursesubdirs; Components: jre
