...
Source: "..\..\..\x64\Release\openmeteo.nsm"; DestDir: "{app}\bin"; Flags: ignoreversion signonce; Components: server
Source: "..\..\..\x64\Release\openmeteo.pdb"; DestDir: "{app}\bin"; Flags: ignoreversion; Components: server and pdb
