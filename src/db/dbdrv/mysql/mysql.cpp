 ...
 */
extern "C" DBDRV_RESULT EXPORT DrvSelectPreparedUnbuffered(MYSQL_CONN *pConn, MYSQL_STATEMENT *hStmt, DWORD *pdwError, WCHAR *errorText)
{
 ...
 */
extern "C" bool EXPORT DrvFetch(MYSQL_UNBUFFERED_RESULT *result)
{
