 ...
 */
public abstract class DataCollectionContainer extends DataCollectionTarget implements AutoBindObject, PollingTarget
{
    ...
    * @param session owning client session
	 */
	protected DataCollectionContainer(NXCPMessage msg, NXCSession session)
	{
		super(msg, session);
