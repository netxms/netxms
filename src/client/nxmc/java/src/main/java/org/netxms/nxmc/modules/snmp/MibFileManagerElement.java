 ...
 */
public class MibFileManagerElement implements ConfigurationPerspectiveElement
{
   private final I18n i18n = LocalizationHelper.getI18n(MibFileManagerElement.class);
   ...
   {
      return ResourceManager.getImageDescriptor("icons/config-views/mib-files.png");
   }
