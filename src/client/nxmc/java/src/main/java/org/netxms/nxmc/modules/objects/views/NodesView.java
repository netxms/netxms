...
public class NodesView extends ObjectView
{
   ...
   protected void createContent(Composite parent)
	{
      final String[] names = {
		...
		WidgetHelper.restoreTableViewerSettings(viewer, "NodeTable.V2"); //$NON-NLS-1$
		viewer.getTable().addDisposeListener(new DisposeListener() {
			@Override
			public void widgetDisposed(DisposeEvent e)
			{
				WidgetHelper.saveColumnSettings(viewer.getTable(), "NodeTable.V2"); //$NON-NLS-1$
			}
		});
		createActions();
		createContextMenu();
   ...
   {
		return (context instanceof Subnet) || (context instanceof Cluster) || (context instanceof Container) || (context instanceof ServiceRoot) || (context instanceof Rack);
	}
