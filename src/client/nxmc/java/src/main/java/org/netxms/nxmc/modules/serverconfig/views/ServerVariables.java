...
public class ServerVariables extends ConfigurationView
{
   ...
   private static final String TABLE_CONFIG_PREFIX = "ServerConfiguration";
   ...
   {            
      ...
      actionShowFilter.setChecked(PreferenceStore.getInstance().getAsBoolean("ServerConfiguration.showFilter", true));
