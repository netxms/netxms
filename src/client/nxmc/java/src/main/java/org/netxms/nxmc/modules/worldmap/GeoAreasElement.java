...
/**
 * Configuration perspective element for geo areas
 */
public class GeoAreasElement implements ConfigurationPerspectiveElement
{
   private static final I18n i18n = LocalizationHelper.getI18n(GeoAreasElement.class);
   ...
   {
      return i18n.tr("Geographical areas");
   }
   ...
   {
      return ResourceManager.getImageDescriptor("icons/config-views/geo-areas.png");
   }
