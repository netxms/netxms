...
public class ShowHistoricalDataMenuItems
{
   ...
   protected void createActions()
   {
      ...
      actionShowRealTimeChart = new Action(i18n.tr("&Real-time line chart"), ResourceManager.getImageDescriptor("icons/object-views/rt-chart-line.png")) {
         @Override
         public void run()
         {
            showRealTimeChart();
      ...
      view.addKeyBinding("M1+M3+L", actionShowRealTimeChart);
