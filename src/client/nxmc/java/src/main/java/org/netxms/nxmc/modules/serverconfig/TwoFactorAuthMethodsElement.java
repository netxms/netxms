 ...
 */
public class TwoFactorAuthMethodsElement implements ConfigurationPerspectiveElement
{
   private static final I18n i18n = LocalizationHelper.getI18n(TwoFactorAuthMethodsElement.class);
   ...
   {
      return i18n.tr("Two-factor authentication methods");
   }
   ...
   {
      return ResourceManager.getImageDescriptor("icons/config-views/2fa.png");
   }
   ...
   {
      return new TwoFactorAuthenticationMethods();
   }
}
