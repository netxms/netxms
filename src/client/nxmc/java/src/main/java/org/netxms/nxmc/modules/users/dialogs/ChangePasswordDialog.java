...
{
   private final I18n i18n = LocalizationHelper.getI18n(ChangePasswordDialog.class);
    ...
    */
	...
	protected Control createDialogArea(Composite parent)
	{
      ...
      final Image image = ResourceManager.getImageDescriptor("icons/password.png").createImage();
      ...
      pic.setImage(image);
		...
		{
         textOldPassword = WidgetHelper.createLabeledText(editArea, SWT.SINGLE | SWT.BORDER | SWT.PASSWORD, SWT.DEFAULT, i18n.tr("Old password"), "", null);
		}
      textPassword1 = WidgetHelper.createLabeledText(editArea, SWT.SINGLE | SWT.BORDER | SWT.PASSWORD, SWT.DEFAULT, i18n.tr("New password"), "", null);
      textPassword2 = WidgetHelper.createLabeledText(editArea, SWT.SINGLE | SWT.BORDER | SWT.PASSWORD, SWT.DEFAULT, i18n.tr("Confirm new password"), "", null);
