...
public class Transformation extends AbstractDCIPropertyPage
{
   ...
   public Transformation(DataCollectionObjectEditor editor)
   {
	...
	protected Control createContents(Composite parent)
	{
      ...
      {
	      deltaCalculation = WidgetHelper.createLabeledCombo(dialogArea, SWT.BORDER | SWT.READ_ONLY, i18n.tr("Step 1 - delta calculation"),
      ...
      final WidgetFactory factory = new WidgetFactory() {
			...
			{
				return new ScriptEditor(dialogArea, style,  SWT.H_SCROLL | SWT.V_SCROLL, true, 
      ...
      if (editor.getObject() instanceof DataCollectionItem)
      {
	      ...
	      testScriptButton.setText(i18n.tr("Messages.get().Transformation_Test)Test..."));   
	      gd = new GridData();
