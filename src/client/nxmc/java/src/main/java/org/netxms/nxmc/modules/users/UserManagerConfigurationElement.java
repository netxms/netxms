 ...
 */
package org.netxms.nxmc.modules.users;
...
/**
 * Configuration perspective element for server configuration 
 */
public class UserManagerConfigurationElement implements ConfigurationPerspectiveElement
{
   private static final I18n i18n = LocalizationHelper.getI18n(UserManagerConfigurationElement.class);
   ...
   {
      return i18n.tr("Users and groups");
   }
   ...
   {
      return ResourceManager.getImageDescriptor("icons/config-views/user_manager.png");
   }
