...
/**
 * Dialog for selecting a traffic observer metric served by the connector for a
 * traffic observer, observation point, or observed node.
 */
public class SelectTrafficMetricDlg extends Dialog implements IParameterSelectionDialog
{
   private static final String CONFIG_PREFIX = "SelectTrafficMetricDlg";
   ...
   private final I18n i18n = LocalizationHelper.getI18n(SelectTrafficMetricDlg.class);
   ...
   private TrafficMetric selectedMetric;

   /**
    * @param parentShell parent shell
    * @param objectId ID of the DCI target object
    * @param tableMode true if selecting a table metric
    */
   public SelectTrafficMetricDlg(Shell parentShell, long objectId, boolean tableMode)
   {
      super(parentShell);
   ...
   protected void configureShell(Shell newShell)
   {
      ...
      newShell.setText(i18n.tr("Select Traffic Metric"));
      PreferenceStore settings = PreferenceStore.getInstance();
      try
      {
         newShell.setSize(settings.getAsPoint(CONFIG_PREFIX + ".size", 700, 400));
      }
   ...
   protected Control createDialogArea(Composite parent)
   {
      ...
      label.setText(i18n.tr("Available metrics"));
      ...
      final String[] names = { i18n.tr("Name"), i18n.tr("Display name"), i18n.tr("Unit"), i18n.tr("Description") };
      final int[] widths = { 220, 160, 80, 300 };
   ...
   /**
    * Fill list with metrics offered for the target object
    */
   private void fillList()
   {
      final NXCSession session = Registry.getSession();
      new Job(String.format(i18n.tr("Reading traffic metrics for %s"), (object != null) ? object.getObjectName() : Long.toString(objectId)), null) {
         @Override
         ...
         {
            return i18n.tr("Cannot read list of traffic metrics");
         }
      }.start();
   }
   ...
   protected void okPressed()
   {
      ...
      selectedMetric = (TrafficMetric)selection.getFirstElement();
      saveSettings();
      super.okPressed();
   }
    ...
    */
   public TrafficMetric getSelectedMetric()
   {
   ...
   public String getParameterDescription()
   {
      if (selectedMetric == null)
         return "";
      return !selectedMetric.getDisplayName().isEmpty() ? selectedMetric.getDisplayName() : selectedMetric.getName();
   }
   ...
   /**
    * Filter matching metric name, display name, or description against the filter text
    */
