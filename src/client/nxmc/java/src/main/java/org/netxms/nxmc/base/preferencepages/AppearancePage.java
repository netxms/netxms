...
public class AppearancePage extends PropertyPage
{
   ...
   protected Control createContents(Composite parent)
   {
      ...
      checkShowWelcomePage.setSelection(!settings.getAsBoolean("WelcomePage.Disabled", !Registry.getSession().getClientConfigurationHintAsBoolean("EnableWelcomeScreen", true)));
