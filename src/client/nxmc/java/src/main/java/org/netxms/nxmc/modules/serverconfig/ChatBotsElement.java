...
/**
 * Configuration perspective element for chat bots
 */
public class ChatBotsElement implements ConfigurationPerspectiveElement
{
   private final I18n i18n = LocalizationHelper.getI18n(ChatBotsElement.class);
