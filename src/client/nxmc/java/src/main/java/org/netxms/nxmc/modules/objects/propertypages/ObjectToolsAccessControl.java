 ...
 */
public class ObjectToolsAccessControl extends PropertyPage
{
   private static final I18n i18n = LocalizationHelper.getI18n(ObjectToolsAccessControl.class);
    ...
    * @param toolDetails
    */
   public ObjectToolsAccessControl(ObjectToolDetails toolDetails)
   {
