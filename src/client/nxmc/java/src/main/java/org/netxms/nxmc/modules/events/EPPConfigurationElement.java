...
/**
 * Configuration perspective element for event processing policy
 */
public class EPPConfigurationElement implements ConfigurationPerspectiveElement
{
   private static final I18n i18n = LocalizationHelper.getI18n(EPPConfigurationElement.class);
   ...
   {
      return i18n.tr("Event processing policy");
   }
