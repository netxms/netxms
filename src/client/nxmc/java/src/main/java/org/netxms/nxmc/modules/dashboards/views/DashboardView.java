...
public class DashboardView extends AbstractDashboardView
{
   ...
   {
      return (context != null) && ((context instanceof Dashboard) || (context instanceof DashboardTemplate));
   }
   ...
   {      
      ...
      if ((getObject() instanceof Dashboard) && (((Dashboard)dashboard).isTemplateInstance()))
         rebuildDashboard((DashboardBase)object, session.findObjectById(((Dashboard)dashboard).getForcedContextObjectId()));
      else
         rebuildDashboard((DashboardBase)object, dashboard.isShowContentSelector() ? selectedContext : null);
   }
