 ...
 * Dashboard view
 */
public class DashboardView extends ObjectView
{
   ...
   {
      super(i18n.tr("Dashboard"), ResourceManager.getImageDescriptor("icons/object-views/dashboard.png"), "DashboardView", false);
   }
