 ...
 */
public class ObjectToolsFilterPropertyPage extends PropertyPage
{
   private static final I18n i18n = LocalizationHelper.getI18n(ObjectToolsFilterPropertyPage.class);
    ...
    * @param toolDetails
    */
   public ObjectToolsFilterPropertyPage(ObjectAction action)
   {
      super("Filter");
    ...
    * @param toolDetails
    */
   public ObjectToolsFilterPropertyPage(ObjectToolDetails toolDetails)
   {
      super("Filter");
      noDefaultAndApplyButton();
