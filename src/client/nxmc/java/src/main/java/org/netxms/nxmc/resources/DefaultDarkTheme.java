...
public class DefaultDarkTheme extends Theme
{
   ...
   public DefaultDarkTheme()
   {
      ...
      elements.put("RuleEditor.Title.Error", new ThemeElement(new RGB(110, 64, 56), null));
      ...
      elements.put("RuleEditor.Border.Error", new ThemeElement(new RGB(104, 74, 70), null));
      ...
      elements.put("Window.PerspectiveSwitcher", new ThemeElement(new RGB(17, 60, 81), new RGB(240, 240, 240)));
      elements.put("Window.PerspectiveSwitcher.Selection", new ThemeElement(new RGB(0xFF, 0x72, 0x01), new RGB(255, 255, 255)));
      elements.put("Window.PerspectiveSwitcher.Hover", new ThemeElement(new RGB(0, 72, 104), null));
      elements.put("Window.PerspectiveSwitcher.SectionHeader", new ThemeElement(null, new RGB(150, 180, 200)));
   }
}
