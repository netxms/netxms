...
/**
 * Tools perspective element for interactive network range scan
 */
public class NetworkScanDescriptor implements ToolDescriptor
{
   private final I18n i18n = LocalizationHelper.getI18n(NetworkScanDescriptor.class);
