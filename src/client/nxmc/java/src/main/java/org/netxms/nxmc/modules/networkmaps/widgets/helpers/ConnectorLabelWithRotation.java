 ...
 * Connector label
 */
public class ConnectorLabelWithRotation extends Label
{
   ...
   private MapLabelProvider labelProvider;
	 ...
	 */
	public ConnectorLabelWithRotation(String s, MapLabelProvider labelProvider)
	{
		super(s);
		initLabel();
    ...
    */
   public ConnectorLabelWithRotation(String s, MapLabelProvider labelProvider, Color backgroundColor)
   {
      super(s);
	 ...
	 */
	public ConnectorLabelWithRotation(String s, Image i)
	{
		super(s, i);
		initLabel();
	}
