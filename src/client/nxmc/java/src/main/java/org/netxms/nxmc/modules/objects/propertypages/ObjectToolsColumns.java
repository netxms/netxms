...
import org.netxms.nxmc.modules.objects.dialogs.EditColumnDialog;
import org.netxms.nxmc.modules.objects.propertypages.helpers.ToolColumnLabelProvider;
 ...
 */
public class ObjectToolsColumns extends PropertyPage
{
   private static final I18n i18n = LocalizationHelper.getI18n(ObjectToolsColumns.class);
    ...
    * @param toolDetails
    */
   public ObjectToolsColumns(ObjectToolDetails toolDetails)
   {
      super("Columns");
