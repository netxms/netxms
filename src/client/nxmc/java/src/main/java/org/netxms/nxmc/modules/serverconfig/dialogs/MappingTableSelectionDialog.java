...
public class MappingTableSelectionDialog extends Dialog
{
    ...
    * @param mappingTables list of available mapping tables
    */
   public MappingTableSelectionDialog(Shell parentShell, List<MappingTableDescriptor> mappingTables)
   {
      super(parentShell);
   ...
   protected Control createDialogArea(Composite parent)
   {
      ...
      viewer.setInput(mappingTables.toArray());
    ...
    */
   public List<MappingTableDescriptor> getSelection()
   {
      return selection;
   }
}
