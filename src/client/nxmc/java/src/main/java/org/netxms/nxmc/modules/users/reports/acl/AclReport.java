...
public class AclReport extends AbstractAclReport
{
   ...
   protected void generatePermissionsSheet(XSSFWorkbook wb, XSSFCellStyle headerStyle, List<ObjectAccess> permissions)
   {
      ...
      cell = headerRow.createCell(PermissionsSheetCells.READ_DEVICE_CONFIG.ordinal());
      cell.setCellStyle(headerStyle);
      cell.setCellValue("Read Device Configuration");

      cell = headerRow.createCell(PermissionsSheetCells.READ_DC_CONFIG.ordinal());
      cell.setCellStyle(headerStyle);
