 ...
 */
public class ExportFileBuilderElement implements ConfigurationPerspectiveElement
{
   private static final I18n i18n = LocalizationHelper.getI18n(ExportFileBuilderElement.class);
   ...
   {
      return ResourceManager.getImageDescriptor("icons/config-views/export.png");
   }
