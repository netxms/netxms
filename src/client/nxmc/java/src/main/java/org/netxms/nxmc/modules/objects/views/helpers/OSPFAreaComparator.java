...
public class OSPFAreaComparator extends ViewerComparator
{
   ...
   {
      OSPFArea a1 = (OSPFArea)e1;
      OSPFArea a2 = (OSPFArea)e2;
      ...
      switch(column)
      {
         case OSPFView.COLUMN_AREA_ABR:
            result = a1.getAreaBorderRouterCount() - a2.getAreaBorderRouterCount();
            break;
         case OSPFView.COLUMN_AREA_ASBR:
            result = a1.getAsBorderRouterCount() - a2.getAsBorderRouterCount();
            break;
         case OSPFView.COLUMN_AREA_ID:
            result = ComparatorHelper.compareInetAddresses(a1.getId(), a2.getId());
            break;
         case OSPFView.COLUMN_AREA_LSA:
            result = a1.getLsaCount() - a2.getLsaCount();
            break;
         default:
            result = 0;
            break;
