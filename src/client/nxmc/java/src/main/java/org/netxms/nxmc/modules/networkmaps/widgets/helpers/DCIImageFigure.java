...
public class DCIImageFigure extends DecorationLayerAbstractFigure
{
   ...
   public DCIImageFigure(NetworkMapDCIImage element, MapLabelProvider labelProvider, ExtendedGraphViewer viewer)
   {
      ...
      try
      {
         ...
         Image image = ImageProvider.getInstance().getImage(guid, () -> refresh());
   ...
   /**
    * @see org.netxms.nxmc.modules.networkmaps.widgets.helpers.DecorationLayerAbstractFigure#paintFigure(org.eclipse.draw2d.Graphics)
    */
   @Override
