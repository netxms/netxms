...
public class MapOptions extends ObjectPropertyPage
{
   ...
   private Button checkShowTrafic;
    ...
    */
	...
	protected Control createContents(Composite parent)
	{
      ...
      checkShowTrafic = new Button(linkDisplayGroup, SWT.CHECK);
      checkShowTrafic.setText("Display traffic data");
      checkShowTrafic.setSelection((map.getFlags() & NetworkMap.MF_SHOW_TRAFFIC) != 0);
	...
	protected boolean applyChanges(final boolean isApply)
	{
      ...
      if (checkShowTrafic.getSelection())
