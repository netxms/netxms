...
public class FileDeliveryPolicyEditor extends AbstractPolicyEditor
{
    ...
    * @param style
    */
   public FileDeliveryPolicyEditor(Composite parent, int style, AgentPolicy policy, View view)
   {
