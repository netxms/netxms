...
import org.netxms.nxmc.modules.logviewer.dialogs.OpenTelemetryLogRecordDetailsDialog;

/**
 * Log record details viewer for OpenTelemetry log
 */
public class OpenTelemetryLogRecordDetailsViewer implements LogRecordDetailsViewer
{
   /**
   ...
   {
      OpenTelemetryLogRecordDetailsDialog dlg = new OpenTelemetryLogRecordDetailsDialog(view.getWindow().getShell(), details, record, logHandle);
      dlg.open();
   }
}
