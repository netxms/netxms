...
/**
 * Tools perspective element for find by MAC address tool
 */
public class FindByMacAddressDescriptor implements ToolDescriptor
{
   private final I18n i18n = LocalizationHelper.getI18n(FindByMacAddressDescriptor.class);
   ...
   {
      return i18n.tr("MAC Address Search");
   }
