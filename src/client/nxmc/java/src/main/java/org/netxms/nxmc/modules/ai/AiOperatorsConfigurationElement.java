...
/**
 * Configuration perspective element for AI operators
 */
public class AiOperatorsConfigurationElement implements ConfigurationPerspectiveElement
{
   private final I18n i18n = LocalizationHelper.getI18n(AiOperatorsConfigurationElement.class);
   ...
   {
      return ResourceManager.getImageDescriptor("icons/config-views/ai-operators.png");
   }
