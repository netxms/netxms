...
public class MultiNodeCommandExecutor extends ObjectView
{
   ...
   private List<String> aplObj;

   private List<String> sourceObj;
    ...
    */
   public void restoreContextObjects(Set<ObjectContext> destinationList, List<String> sourceList) throws IOException, NXCException
   {
   ...
   public void restoreState()
   {
      ...
      Job job = new Job(i18n.tr("Find alarm id"), this) {
         ...
         {     
            restoreContextObjects(applicableObjects, aplObj);
            restoreContextObjects(sourceObjects, sourceObj);
   ...
   public void restoreState(Memento memento) throws ViewNotRestoredException
   {
      ...
      aplObj = memento.getAsStringList("applicableObjects");
      sourceObj = memento.getAsStringList("sourceObjects");
   }
}
