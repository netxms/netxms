...
/**
 * Configuration perspective element for network discovery
 */
public class NetworkDiscoveryElement implements ConfigurationPerspectiveElement
{
   private static final I18n i18n = LocalizationHelper.getI18n(NetworkDiscoveryElement.class);
   ...
   {
      return i18n.tr("Network discovery");
   }
   ...
   {
      return ResourceManager.getImageDescriptor("icons/config-views/network-discovery.gif");
   }
   ...
   {
      return new NetworkDiscoveryConfigurator();
   }
}
