...
import org.netxms.nxmc.modules.logviewer.dialogs.AiObservationLogRecordDetailsDialog;

/**
 * Log record details viewer for AI operator observation log
 */
public class AiObservationLogRecordDetailsViewer implements LogRecordDetailsViewer
{
   /**
   ...
   {
      AiObservationLogRecordDetailsDialog dlg = new AiObservationLogRecordDetailsDialog(view.getWindow().getShell(), details, record, logHandle);
      dlg.open();
   }
}
