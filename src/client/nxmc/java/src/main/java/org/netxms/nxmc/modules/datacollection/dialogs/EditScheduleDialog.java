...
public class EditScheduleDialog extends Dialog
{
   private final I18n i18n = LocalizationHelper.getI18n(EditScheduleDialog.class);
	...
	protected Control createDialogArea(Composite parent)
	{
      ...
      textSchedule = WidgetHelper.createLabeledText(dialogArea, SWT.SINGLE | SWT.BORDER, SWT.DEFAULT, i18n.tr("Schedule"), schedule,
	...
	protected void configureShell(Shell newShell)
	{
		...
		newShell.setText(i18n.tr("Edit Schedule"));
	}
}
