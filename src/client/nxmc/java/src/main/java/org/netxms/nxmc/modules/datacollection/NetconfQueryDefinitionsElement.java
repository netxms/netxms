...
/**
 * NETCONF query definitions configuration element
 */
public class NetconfQueryDefinitionsElement implements ConfigurationPerspectiveElement
{
   private final I18n i18n = LocalizationHelper.getI18n(NetconfQueryDefinitionsElement.class);
   ...
   {
      return i18n.tr("NETCONF queries");
   }
   ...
   {
      return new NetconfQueryManager();
   }
}
