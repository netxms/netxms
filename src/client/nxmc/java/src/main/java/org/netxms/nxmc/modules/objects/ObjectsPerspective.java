...
import org.netxms.nxmc.modules.networkmaps.views.IPTopology;
import org.netxms.nxmc.modules.networkmaps.views.InternalConnectionTopology;
import org.netxms.nxmc.modules.networkmaps.views.Layer2Topology;
...
public abstract class ObjectsPerspective extends Perspective implements ISelectionProvider
{
   ...
   protected void configureViews()
   {
      ...
      addMainView(new InternalConnectionTopology());
      addMainView(new IPTopology());
      addMainView(new Layer2Topology());
