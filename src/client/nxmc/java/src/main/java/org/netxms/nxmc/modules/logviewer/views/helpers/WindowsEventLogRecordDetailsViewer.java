...
import org.netxms.nxmc.modules.logviewer.dialogs.WindowsEventLogRecordDetailsDialog;
...
public class WindowsEventLogRecordDetailsViewer implements LogRecordDetailsViewer
{
   ...
   {
      WindowsEventLogRecordDetailsDialog dlg = new WindowsEventLogRecordDetailsDialog(view.getWindow().getShell(), details, record, logHandle);
      dlg.open();
   }
}
