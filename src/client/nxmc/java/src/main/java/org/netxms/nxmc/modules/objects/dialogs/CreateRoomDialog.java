...
/**
 * Room object creation dialog. Asks for room width and depth; server generates rectangular outline from them (outline can be
 * changed later in floor plan editor).
 */
public class CreateRoomDialog extends Dialog
{
   private final I18n i18n = LocalizationHelper.getI18n(CreateRoomDialog.class);

   private LabeledText nameField;
   private LabeledText aliasField;
   private LabeledCombo roomTypeField;
   ...
   protected void configureShell(Shell newShell)
   {
      ...
      newShell.setText(i18n.tr("Create Room"));
   }
   ...
   protected Control createDialogArea(Composite parent)
   {
      ...
      roomTypeField = new LabeledCombo(dialogArea, SWT.NONE);
      roomTypeField.setLabel(i18n.tr("Room type"));
      roomTypeField.setContent(RoomTypeLabels.getAll());
      roomTypeField.select(RoomType.COMPUTER_ROOM.getValue());
      gd = new GridData();
      gd.horizontalAlignment = SWT.FILL;
      gd.grabExcessHorizontalSpace = true;
      gd.horizontalSpan = 3;
      roomTypeField.setLayoutData(gd);

      widthField = new LabeledSpinner(dialogArea, SWT.NONE);
      widthField.setLabel(i18n.tr("Width (mm)"));
      widthField.setRange(100, 1000000);
      widthField.setSelection(6000);
      widthField.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));

      depthField = new LabeledSpinner(dialogArea, SWT.NONE);
      depthField.setLabel(i18n.tr("Depth (mm)"));
      depthField.setRange(100, 1000000);
      depthField.setSelection(6000);
      depthField.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false));

      heightField = new LabeledSpinner(dialogArea, SWT.NONE);
      heightField.setLabel(i18n.tr("Height (mm, 0 = undeclared)"));
      heightField.setRange(0, 100000);
      heightField.setSelection(0);
   ...
   protected void okPressed()
   {
      ...
      roomType = RoomType.getByValue(roomTypeField.getSelectionIndex());
   ...
   /**
    * @return room width in millimetres
    */
   public int getWidth()
   {
      return width;
   ...
   /**
    * @return room depth in millimetres
    */
   public int getDepth()
   {
      return depth;
   ...
   /**
    * @return room height in millimetres (0 if undeclared)
    */
