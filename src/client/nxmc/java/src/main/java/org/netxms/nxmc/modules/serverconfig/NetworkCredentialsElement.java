...
/**
 * Configuration perspective element for network credentials
 */
public class NetworkCredentialsElement implements ConfigurationPerspectiveElement
{
   private static final I18n i18n = LocalizationHelper.getI18n(NetworkCredentialsElement.class);
   ...
   {
      return i18n.tr("Network credentials");
   }
   ...
   {
      return ResourceManager.getImageDescriptor("icons/config-views/network_credentials.png");
   }
   ...
   {
      return new NetworkCredentialsEditor();
   }
}
