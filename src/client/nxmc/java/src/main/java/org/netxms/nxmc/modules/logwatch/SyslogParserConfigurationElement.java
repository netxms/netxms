 ...
 */
package org.netxms.nxmc.modules.logwatch;
...
/**
 * Configuration perspective element for syslog parser
 */
public class SyslogParserConfigurationElement implements ConfigurationPerspectiveElement
{
   ...
   {
      return ResourceManager.getImageDescriptor("icons/config-views/log-parser.png");
   }
