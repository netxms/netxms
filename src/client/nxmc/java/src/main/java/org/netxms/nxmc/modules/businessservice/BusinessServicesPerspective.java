...
public class BusinessServicesPerspective extends ObjectsPerspective
{
   ...
   {
      super("objects.business-services", LocalizationHelper.getI18n(BusinessServicesPerspective.class).tr("Business Services"),
            "icons/perspectives/business-services.svg", SubtreeType.BUSINESS_SERVICES, null);
   }
