...
public class DefaultLightTheme extends Theme
{
   ...
   public DefaultLightTheme()
   {
      ...
      elements.put("Map.ObjectTooltip", new ThemeElement(new RGB(236, 240, 246), new RGB(32, 32, 32)));
      ...
      elements.put("Window.PerspectiveSwitcher", new ThemeElement(new RGB(17, 60, 81), new RGB(255, 255, 255)));
      elements.put("Window.PerspectiveSwitcher.Selection", new ThemeElement(new RGB(0xFF, 0x72, 0x01), new RGB(255, 255, 255)));
      elements.put("Window.PerspectiveSwitcher.Hover", new ThemeElement(new RGB(0x1A, 0x7A, 0x9E), null));
