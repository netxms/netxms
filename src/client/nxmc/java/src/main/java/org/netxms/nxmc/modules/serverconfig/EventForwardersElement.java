...
/**
 * Configuration perspective element for event forwarders
 */
public class EventForwardersElement implements ConfigurationPerspectiveElement
{
   private final I18n i18n = LocalizationHelper.getI18n(EventForwardersElement.class);
   ...
   {
      return i18n.tr("Event forwarders");
   }
