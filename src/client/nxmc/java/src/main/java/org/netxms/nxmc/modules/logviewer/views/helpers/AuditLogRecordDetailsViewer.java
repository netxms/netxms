...
import org.netxms.nxmc.modules.logviewer.dialogs.AuditLogRecordDetailsDialog;
...
public class AuditLogRecordDetailsViewer implements LogRecordDetailsViewer
{
   ...
   {
      AuditLogRecordDetailsDialog dlg = new AuditLogRecordDetailsDialog(view.getWindow().getShell(), details);
      dlg.open();
   }
}
