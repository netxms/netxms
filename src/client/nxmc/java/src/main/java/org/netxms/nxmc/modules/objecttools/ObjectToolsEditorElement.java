 ...
 */
public class ObjectToolsEditorElement implements ConfigurationPerspectiveElement
{
   private static final I18n i18n = LocalizationHelper.getI18n(ObjectToolsEditorElement.class);
   ...
   {
      return ResourceManager.getImageDescriptor("icons/config-views/tools.png");
   }
