...
public abstract class AbstractDashboardView extends ObjectView
{
   ...
   private void exportLineChartValues()
   {
      ...
      new Job(i18n.tr("Export line chart data"), this) {
         ...
         protected void run(IProgressMonitor monitor) throws Exception
         {
            ...
            final File tmpFile = File.createTempFile("ExportDashboardCSV_" + AbstractDashboardView.this.hashCode(), "_" + System.currentTimeMillis());
            ...
            DownloadServiceHandler.addDownload(tmpFile.getName(), getObjectName() + ".csv", tmpFile, "text/csv");
   ...
   public void saveAsImage()
   {
      ...
      if (executor != null)
      {
         ...
         js.append(WidgetUtil.getId(dbc));
