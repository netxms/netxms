...
public final class LocalizationHelper
{
   ...
   /**
    * Convert a language code (e.g. {@code "pt_BR"} or {@code "pt-BR"}) to a {@link Locale}. Language codes stored in preferences use
    * underscores as separator, but {@link Locale#forLanguageTag(String)} requires the BCP 47 hyphen separator, so we normalise before
    * parsing.
    *
   ...
   public static Locale localeFromLanguageCode(String languageCode)
   {
      ...
      logger.debug("localeFromLanguageCode(\"{}\") -> language={}, country={}, toLanguageTag={}",
            languageCode, locale.getLanguage(), locale.getCountry(), locale.toLanguageTag());
      return locale;
   }
