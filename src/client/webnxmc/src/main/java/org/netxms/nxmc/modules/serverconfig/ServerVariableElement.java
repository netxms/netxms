 ...
 */
public class ServerVariableElement implements ConfigurationPerspectiveElement
{
   private static final I18n i18n = LocalizationHelper.getI18n(ServerVariableElement.class);
   ...
   {
      return i18n.tr("Server configuration");
   }
   ...
   {
      return ResourceManager.getImageDescriptor("icons/config-views/server_config.png");
   }
