   ...
   private void fillMetricList()
	{
		...
		list.add(new AgentParameter("ChildStatus(*)", "Status of child object {instance}", DataType.INT32)); //$NON-NLS-1$
		list.add(new AgentParameter("ConditionStatus(*)", "Status of condition object {instance}", DataType.INT32)); //$NON-NLS-1$
		list.add(new AgentParameter("Dummy", "Dummy value", DataType.INT32)); //$NON-NLS-1$
      list.add(new AgentParameter("Dummy(*)", "Dummy value", DataType.INT32)); //$NON-NLS-1$
      ...
      list.add(new AgentParameter("Status", "Status", DataType.INT32)); //$NON-NLS-1$
		...
		if ((object instanceof Template) || (object instanceof AbstractNode))
		{
         ...
         list.add(new AgentParameter("Net.IP.NextHop(*)", "Next routing hop for IP address {instance}", DataType.STRING)); //$NON-NLS-1$
		...
		{
			list.add(new AgentParameter("AgentStatus", "Status of NetXMS agent", DataType.INT32)); //$NON-NLS-1$
		}
		...
		if ((object instanceof Template) || ((object instanceof AbstractNode) && ((AbstractNode)object).isManagementServer()))
		{
         ...
         list.add(new AgentParameter("Server.AverageDCIQueuingTime", "Average time to queue DCI for polling for last minute", DataType.UINT32)); //$NON-NLS-1$
         ...
         list.add(new AgentParameter("Server.TotalEventsProcessed", "Total events processed", DataType.COUNTER64)); //$NON-NLS-1$
		...
		{
			list.add(new AgentParameter("MobileDevice.BatteryLevel", "Battery level", DataType.INT32)); //$NON-NLS-1$
			list.add(new AgentParameter("MobileDevice.DeviceId", "Device ID", DataType.STRING)); //$NON-NLS-1$
			list.add(new AgentParameter("MobileDevice.LastReportTime", "Last report time", DataType.INT64)); //$NON-NLS-1$
			list.add(new AgentParameter("MobileDevice.Model", "Model", DataType.STRING)); //$NON-NLS-1$
			list.add(new AgentParameter("MobileDevice.OS.Name", "Operating system", DataType.STRING)); //$NON-NLS-1$
			list.add(new AgentParameter("MobileDevice.OS.Version", "Operating system version", DataType.STRING)); //$NON-NLS-1$
			list.add(new AgentParameter("MobileDevice.SerialNumber", "Serial number", DataType.STRING)); //$NON-NLS-1$
			list.add(new AgentParameter("MobileDevice.Vendor", "Vendor", DataType.STRING)); //$NON-NLS-1$
			list.add(new AgentParameter("MobileDevice.UserId", "User ID", DataType.STRING)); //$NON-NLS-1$
		}

		if ((object instanceof Template) || ((object instanceof AbstractNode) && ((AbstractNode)object).isWirelessController()))
		{
			list.add(new AgentParameter("WirelessController.AdoptedAPCount", "Adopted access points", DataType.INT32)); //$NON-NLS-1$
			list.add(new AgentParameter("WirelessController.TotalAPCount", "Total access points", DataType.INT32)); //$NON-NLS-1$
			list.add(new AgentParameter("WirelessController.UnadoptedAPCount", "Unadopted access points", DataType.INT32)); //$NON-NLS-1$
		}
