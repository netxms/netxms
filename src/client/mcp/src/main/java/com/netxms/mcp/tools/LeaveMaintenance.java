 ...
 */
public class LeaveMaintenance extends ObjectServerTool
{
   /**
   ...
   {
      return "Leave maintenance mode for a given object. This tool requires an object ID as parameter.";
   }
   ...
   public String getSchema()
   {
      return new SchemaBuilder()
         .addArgument("object_id", "string", "ID or name of the object to return from maintenance mode", true)
         .build();
   }
   ...
   protected String execute(AbstractObject object, Map<String, Object> args) throws Exception
   {
      ...
      session.setObjectMaintenanceMode(object.getObjectId(), false);
      return "Successfully left maintenance mode";
   }
}
